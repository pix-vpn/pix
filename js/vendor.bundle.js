...
+function(f) {
    function g(a) {
        return this.each(function() {
            var b = f(this)
              , d = b.data("bs.alert");
            d || b.data("bs.alert", d = new i(this)),
    ...
    i.prototype.close = function(a) {
        ...
        var m = f("#" === l ? [] : l);
        a && a.preventDefault(),
        m.length || (m = k.closest(".alert")),
        m.trigger(a = f.Event("close.bs.alert")),
        a.isDefaultPrevented() || (m.removeClass("in"),
        f.support.transition && m.hasClass("fade") ? m.one("bsTransitionEnd", d).emulateTransitionEnd(i.TRANSITION_DURATION) : d())
    }
    ;
    var j = f.fn.alert;
    f.fn.alert = g,
    f.fn.alert.Constructor = i,
...
+function(e) {
    function f(a) {
        return this.each(function() {
            var b = e(this)
              , c = b.data("bs.button")
              , i = "object" == typeof a && a;
            c || b.data("bs.button", c = new g(this,i)),
    ...
    g.prototype.setState = function(a) {
        var i = "disabled"
          ...
          , l = j.data();
        a += "Text",
        null == l.resetText && j.data("resetText", j[k]()),
        setTimeout(e.proxy(function() {
            j[k](null == l[a] ? this.options[a] : l[a]),
            "loadingText" == a ? (this.isLoading = !0,
            j.addClass(i).attr(i, i).prop(i, !0)) : this.isLoading && (this.isLoading = !1,
            j.removeClass(i).removeAttr(i).prop(i, !1))
        }, this), 0)
    }
    ,
    g.prototype.toggle = function() {
        ...
        if (i.length) {
            ...
            "radio" == j.prop("type") ? (j.prop("checked") && (d = !1),
            i.find(".active").removeClass("active"),
            this.$element.addClass("active")) : "checkbox" == j.prop("type") && (j.prop("checked") !== this.$element.hasClass("active") && (d = !1),
    ...
    e(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(a) {
        ...
        f.call(b, "toggle"),
        e(a.target).is('input[type="radio"], input[type="checkbox"]') || (a.preventDefault(),
        b.is("input,button") ? b.trigger("focus") : b.find("input:visible,button:visible").first().trigger("focus"))
...
+function(f) {
    function g(a) {
        return this.each(function() {
            ...
            c || b.data("bs.carousel", c = new h(this,k)),
            "number" == typeof a ? c.to(a) : l ? c[l]() : k.interval && c.pause().cycle()
        })
    }
    var h = function(a, d) {
        this.$element = f(a),
    ...
    h.prototype.slide = function(a, c) {
        ...
        !t.isDefaultPrevented()) {
            ...
            return f.support.transition && this.$element.hasClass("slide") ? (o.addClass(a),
            o[0].offsetWidth,
            n.addClass(q),
            o.addClass(q),
            n.one("bsTransitionEnd", function() {
                o.removeClass([a, q].join(" ")).addClass("active"),
                n.removeClass(["active", q].join(" ")),
                r.sliding = !1,
                setTimeout(function() {
                    r.$element.trigger(v)
                }, 0)
    ...
    f.fn.carousel.noConflict = function() {
        return f.fn.carousel = i,
        this
    }
    ;
    var j = function(a) {
        var b, k = f(this), l = f(k.attr("data-target") || (b = k.attr("href")) && b.replace(/.*(?=#[^\s]+$)/, ""));
        if (l.hasClass("carousel")) {
            var m = f.extend({}, l.data(), k.data())
              , n = k.attr("data-slide-to");
            n && (m.interval = !1),
            g.call(l, m),
            n && l.data("bs.carousel").to(n),
            a.preventDefault()
        }
    };
    f(document).on("click.bs.carousel.data-api", "[data-slide]", j).on("click.bs.carousel.data-api", "[data-slide-to]", j),
...
+function(f) {
    ...
    function h(a) {
        return this.each(function() {
            ...
            !d && k.toggle && /show|hide/.test(a) && (k.toggle = !1),
            d || b.data("bs.collapse", d = new i(this,k)),
            "string" == typeof a && d[a]()
        })
    }
    var i = function(a, d) {
        this.$element = f(a),
        this.options = f.extend({}, i.DEFAULTS, d),
        this.$trigger = f('[data-toggle="collapse"][href="#' + a.id + '"],[data-toggle="collapse"][data-target="#' + a.id + '"]'),
    ...
    i.prototype.show = function() {
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (!(c && c.length && (a = c.data("bs.collapse"),
            a && a.transitioning))) {
                var d = f.Event("show.bs.collapse");
                if (this.$element.trigger(d),
                !d.isDefaultPrevented()) {
                    c && c.length && (h.call(c, "hide"),
                    a || c.data("bs.collapse", null));
                    ...
                    this.$element.one("bsTransitionEnd", f.proxy(l, this)).emulateTransitionEnd(i.TRANSITION_DURATION)[k](this.$element[0][m])
                }
            }
        }
    }
    ...
    i.prototype.hide = function() {
        if (!this.transitioning && this.$element.hasClass("in")) {
            ...
            !a.isDefaultPrevented()) {
                ...
                return f.support.transition ? void this.$element[d](0).one("bsTransitionEnd", f.proxy(k, this)).emulateTransitionEnd(i.TRANSITION_DURATION) : k.call(this)
            }
        }
    }
    ,
    ...
    i.prototype.getParent = function() {
        return f(this.options.parent).find('[data-toggle="collapse"][data-parent="' + this.options.parent + '"]').each(f.proxy(function(a, b) {
            var k = f(b);
    ...
    i.prototype.addAriaAndCollapsedClass = function(d, e) {
        var k = d.hasClass("in");
        d.attr("aria-expanded", k),
        e.toggleClass("collapsed", !k).attr("aria-expanded", k)
    }
    ;
    var j = f.fn.collapse;
    f.fn.collapse = h,
    f.fn.collapse.Constructor = i,
    f.fn.collapse.noConflict = function() {
        return f.fn.collapse = j,
        this
    }
    ,
...
+function(i) {
    ...
    function k(a) {
        ...
        i(n).each(function() {
            ...
            c.hasClass("open") && (a && "click" == a.type && /input|textarea/i.test(a.target.tagName) && i.contains(c[0], a.target) || (c.trigger(a = i.Event("hide.bs.dropdown", g)),
            a.isDefaultPrevented() || (b.attr("aria-expanded", "false"),
            c.removeClass("open").trigger(i.Event("hidden.bs.dropdown", g)))))
        }))
    }
    function l(a) {
        return this.each(function() {
            ...
            e || b.data("bs.dropdown", e = new o(this)),
    ...
    o.prototype.toggle = function(a) {
        ...
        if (!b.is(".disabled, :disabled")) {
            ...
            if (k(),
            !q) {
                "ontouchstart"in document.documentElement && !c.closest(".navbar-nav").length && i(document.createElement("div")).addClass("dropdown-backdrop").insertAfter(i(this)).on("click", k);
                var r = {
                    relatedTarget: this
                };
                if (c.trigger(a = i.Event("show.bs.dropdown", r)),
                a.isDefaultPrevented()) {
                    return
                }
                b.trigger("focus").attr("aria-expanded", "true"),
                c.toggleClass("open").trigger(i.Event("shown.bs.dropdown", r))
            }
            return !1
        }
    }
        ...
        if (/(38|40|27|32)/.test(a.which) && !/input|textarea/i.test(a.target.tagName)) {
            ...
            !b.is(".disabled, :disabled")) {
                ...
                if (!q && 27 != a.which || q && 27 == a.which) {
                    return 27 == a.which && f.find(n).trigger("focus"),
                    b.trigger("click")
                }
                ...
                if (s.length) {
                    ...
                    38 == a.which && t > 0 && t--,
                    40 == a.which && t < s.length - 1 && t++,
                    ~t || (t = 0),
                    s.eq(t).trigger("focus")
                }
            }
        }
    }
    ...
    ,
    i(document).on("click.bs.dropdown.data-api", k).on("click.bs.dropdown.data-api", ".dropdown form", function(b) {
        b.stopPropagation()
...
+function(e) {
    function f(a, c) {
        return this.each(function() {
            ...
            d || b.data("bs.modal", d = new g(this,i)),
            "string" == typeof a ? d[a](c) : i.show && d.show(c)
        })
    }
    var g = function(a, d) {
        this.options = d,
    ...
    g.prototype.hide = function(a) {
        ...
        e.support.transition && this.$element.hasClass("fade") ? this.$element.one("bsTransitionEnd", e.proxy(this.hideModal, this)).emulateTransitionEnd(g.TRANSITION_DURATION) : this.hideModal())
    }
    ,
    ...
    g.prototype.backdrop = function(a) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            this.$element.on("click.dismiss.bs.modal", e.proxy(function(b) {
            ...
            if (!this.isShown && this.$backdrop) {
                ...
                e.support.transition && this.$element.hasClass("fade") ? this.$backdrop.one("bsTransitionEnd", k).emulateTransitionEnd(g.BACKDROP_TRANSITION_DURATION) : k()
            } else {
                a && a()
            }
        }
    ...
    e(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(a) {
        ...
        j.one("show.bs.modal", function(c) {
...
+function(e) {
    function f(a) {
        return this.each(function() {
            var b = e(this)
              , c = b.data("bs.tooltip")
              , i = "object" == typeof a && a;
            !c && /destroy|hide/.test(a) || (c || b.data("bs.tooltip", c = new g(this,i)),
            "string" == typeof a && c[a]())
        })
    }
    var g = function(c, d) {
        ...
        for (var l = this.options.trigger.split(" "), m = l.length; m--; ) {
            ...
            if ("click" == n) {
                ...
                if ("manual" != n) {
                    ...
                    this.$element.on(p + "." + this.type, this.options.selector, e.proxy(this.leave, this))
                }
            }
        }
    ...
    g.prototype.getOptions = function(a) {
        return a = e.extend({}, this.getDefaults(), this.$element.data(), a),
    ...
    g.prototype.enter = function(a) {
        ...
        a instanceof e.Event && (d.inState["focusin" == a.type ? "focus" : "hover"] = !0),
    ...
    g.prototype.leave = function(a) {
        var d = a instanceof this.constructor ? a : e(a.currentTarget).data("bs." + this.type);
        if (d || (d = new this.constructor(a.currentTarget,this.getDelegateOptions()),
        e(a.currentTarget).data("bs." + this.type, d)),
        a instanceof e.Event && (d.inState["focusout" == a.type ? "focus" : "hover"] = !1),
        !d.isInStateTrue()) {
    ...
    g.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (w) {
                ...
                u = "bottom" == u && x.bottom + z > B.bottom ? "top" : "top" == u && x.top - z < B.top ? "bottom" : "right" == u && x.right + y > B.width ? "left" : "left" == u && x.left - y < B.left ? "right" : u,
                s.removeClass(A).addClass(u)
            }
            ...
            e.support.transition && this.$tip.hasClass("fade") ? s.one("bsTransitionEnd", D).emulateTransitionEnd(g.TRANSITION_DURATION) : D()
        }
    }
    ,
    g.prototype.applyPlacement = function(a, o) {
        ...
        a.top += s,
        a.left += t,
        e.offset.setOffset(p[0], e.extend({
            using: function(b) {
                p.css({
    ...
    g.prototype.hide = function(a) {
        ...
        !k.isDefaultPrevented()) {
            return j.removeClass("in"),
            e.support.transition && j.hasClass("fade") ? j.one("bsTransitionEnd", c).emulateTransitionEnd(g.TRANSITION_DURATION) : c(),
            this.hoverState = null,
            this
        }
    }
    ...
    g.prototype.getTitle = function() {
        var d, i = this.$element, j = this.options;
    ...
    g.prototype.toggle = function(a) {
        var d = this;
        a && (d = e(a.currentTarget).data("bs." + this.type),
...
+function(e) {
    function f(a) {
        return this.each(function() {
            var b = e(this)
              , c = b.data("bs.popover")
              , i = "object" == typeof a && a;
            !c && /destroy|hide/.test(a) || (c || b.data("bs.popover", c = new g(this,i)),
            "string" == typeof a && c[a]())
        })
    }
    var g = function(c, d) {
    ...
    g.prototype.setContent = function() {
        var d = this.tip()
          , i = this.getTitle()
          , j = this.getContent();
        d.find(".popover-title")[this.options.html ? "html" : "text"](i),
        d.find(".popover-content").children().detach().end()[this.options.html ? "string" == typeof j ? "html" : "append" : "text"](j),
...
+function(e) {
    function f(a, b) {
        this.$body = e(document.body),
        this.$scrollElement = e(e(a).is(document.body) ? window : a),
    ...
    function g(a) {
        return this.each(function() {
            var b = e(this)
              ...
              , i = "object" == typeof a && a;
            c || b.data("bs.scrollspy", c = new f(this,i)),
            "string" == typeof a && c[a]()
        })
    }
    f.VERSION = "3.3.7",
    ...
    f.prototype.refresh = function() {
        ...
        e.isWindow(this.$scrollElement[0]) || (i = "position",
        j = this.$scrollElement.scrollTop()),
        this.$body.find(this.selector).map(function() {
            var c = e(this)
              , d = c.data("target") || c.attr("href")
              , k = /^#./.test(d) && e(d);
            return k && k.length && k.is(":visible") && [[k[i]().top + j, d]] || null
        }).sort(function(c, d) {
            return c[0] - d[0]
        }).each(function() {
    ...
    f.prototype.process = function() {
        var i, j = this.$scrollElement.scrollTop() + this.options.offset, k = this.getScrollHeight(), l = this.options.offset + k - this.$scrollElement.height(), m = this.offsets, n = this.targets, o = this.activeTarget;
        if (this.scrollHeight != k && this.refresh(),
        j >= l) {
    ...
    f.prototype.activate = function(a) {
        ...
        j.parent(".dropdown-menu").length && (j = j.closest("li.dropdown").addClass("active")),
        j.trigger("activate.bs.scrollspy")
    }
    ,
...
+function(f) {
    ...
    f(document).on("click.bs.tab.data-api", '[data-toggle="tab"]', j).on("click.bs.tab.data-api", '[data-toggle="pill"]', j)
}(jQuery),
+function(e) {
    function f(a) {
        return this.each(function() {
            var b = e(this)
              , c = b.data("bs.affix")
              , i = "object" == typeof a && a;
            c || b.data("bs.affix", c = new g(this,i)),
            "string" == typeof a && c[a]()
        })
    }
    var g = function(a, c) {
    ...
    g.prototype.checkPosition = function() {
        if (this.$element.is(":visible")) {
            ...
            if (this.affixed != n) {
                ...
                this.$element.removeClass(g.RESET).addClass(o).trigger(o.replace("affix", "affixed") + ".bs.affix")
            }
            ...
            var g = function() {
                ...
                for (var n = j; n >= f.beginAt / t * j; n--) {
                    ...
                    if (p) {
                        ...
                        s = (l < 10 ? "0" + l : l) + ":" + (r < 10 ? "0" + r : r) + ":" + (v < 10 ? "0" + v : v)
                    }
                    if (o) {
...
window.Modernizr = function(A, B, C) {
    ...
    function Y() {
        ...
        E.inputtypes = function(b) {
            for (var c = 0, f, j, k, l = b.length; c < l; c++) {
                K.setAttribute("type", j = b[c]),
                f = K.type !== "text",
                f && (K.value = L,
                K.style.cssText = "position:absolute;visibility:hidden;",
                /^range$/.test(j) && K.style.WebkitAppearance !== C ? (F.appendChild(K),
                k = B.defaultView,
                f = k.getComputedStyle && k.getComputedStyle(K, null).WebkitAppearance !== "textfield" && K.offsetHeight !== 0,
                F.removeChild(K)) : /^(search|tel)$/.test(j) || (/^(url|email)$/.test(j) ? f = K.checkValidity && K.checkValidity() === !1 : /^color$/.test(j) ? (F.appendChild(K),
                F.offsetWidth,
                f = K.value != L,
                F.removeChild(K)) : f = K.value != L)),
                O[b[c]] = !!f
            }
            return O
        }("search tel url email datetime date month week time datetime-local number range color".split(" "))
    }
    var D = "2.0.6", E = {}, F = B.documentElement, G = B.head || B.getElementsByTagName("head")[0], H = "modernizr", I = B.createElement(H), J = I.style, K = B.createElement("input"), L = ":)", M = Object.prototype.toString, N = {}, O = {}, P = {}, Q = [], R, S = {}.hasOwnProperty, T;
    ...
    ;
    for (var Z in N) {
        T(N, Z) && (R = Z.toLowerCase(),
        E[R] = N[Z](),
        Q.push((E[R] ? "" : "no-") + R))
    }
    return E.input || Y(),
    E.addTest = function(c, e) {
        if (typeof c == "object") {
            for (var f in c) {
...
function() {
    ...
    b && ((Modernizr.textarea || (Modernizr.textarea = {})).placeholder = "placeholder"in document.createElement("textarea"))
}();
...
!function() {
    function c(d) {
        ...
        c.offsetAliases[this.options.offset] && (this.options.offset = c.offsetAliases[this.options.offset]),
        this.group.add(this),
...
function() {
    ...
    function a(e) {
        ...
        d[e.waypointContextKey] = this,
        b += 1,
        c.windowContext || (c.windowContext = !0,
        c.windowContext = new a(window)),
    ...
    a.prototype.checkEmpty = function() {
        ...
        k && h && !j && (this.adapter.off(".waypoints"),
        delete d[this.key])
    }
    ,
    ...
    a.prototype.createThrottledScrollHandler = function() {
        ...
        this.adapter.on("scroll.waypoints", function() {
            (!h.didScroll || c.isTouch) && (h.didScroll = !0,
            c.requestAnimationFrame(i))
        })
    }
    ,
            ...
            for (var B in this.waypoints[v]) {
                ...
                if (null !== j.triggerPoint) {
                    var w = y.oldScroll < j.triggerPoint
                      ...
                      , z = w && q
                      , D = !w && !q;
                    (z || D) && (j.queueTrigger(A),
                    C[j.group.id] = j.group)
                }
            }
        }
        for (var k in C) {
    ...
    a.prototype.refresh = function() {
        var F, n = this.element == this.element.window, z = n ? void 0 : this.adapter.offset(), B = {};
        this.handleScroll(),
        F = {
            horizontal: {
        ...
        for (var D in F) {
            ...
            for (var j in this.waypoints[D]) {
                var A, x, C, G, k, m = this.waypoints[D][j], q = m.options.offset, H = m.triggerPoint, I = 0, v = null == H;
                m.element !== m.element.window && (I = m.adapter.offset()[E.offsetProp]),
                "function" == typeof q ? q = q.apply(m) : "string" == typeof q && (q = parseFloat(q),
                m.options.offset.indexOf("%") > -1 && (q = Math.ceil(E.contextDimension * q / 100))),
                A = E.contextScroll - E.contextOffset,
                m.triggerPoint = Math.floor(I + A - q),
                x = H < E.oldScroll,
                C = m.triggerPoint >= E.oldScroll,
                G = x && C,
                k = !x && !C,
                !v && G ? (m.queueTrigger(E.backward),
                B[m.group.id] = m.group) : !v && k ? (m.queueTrigger(E.forward),
                B[m.group.id] = m.group) : v && E.oldScroll >= m.triggerPoint && (m.queueTrigger(E.forward),
                B[m.group.id] = m.group)
            }
        }
    ...
    c.requestAnimationFrame = function(h) {
        var j = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || g;
        j.call(window, h)
    }
    ,
    c.Context = a
...
function() {
    ...
    var a = window.jQuery
      , b = window.Waypoint;
    a.each(["innerHeight", "innerWidth", "off", "offset", "on", "outerHeight", "outerWidth", "scrollLeft", "scrollTop"], function(d, f) {
...
function() {
    function b(c) {
        return function() {
            var d = []
              , e = arguments[0];
            return c.isFunction(arguments[0]) && (e = c.extend({}, arguments[1]),
            e.handler = arguments[0]),
            this.each(function() {
                var f = c.extend({}, e, {
                    element: this
                });
                "string" == typeof f.context && (f.context = c(this).closest(f.context)[0]),
                d.push(new a(f))
            }),
            d
        }
    ...
    window.jQuery && (window.jQuery.fn.waypoint = b(window.jQuery)),
    window.Zepto && (window.Zepto.fn.waypoint = b(window.Zepto))
}();
!function(p, q, r, s) {
    function t(a, d) {
        this.settings = null,
...
}(jQuery))/* skrollr 0.6.30 (2015-08-12) | Alexander Prinzhorn - https://github.com/Prinzhorn/skrollr | Free to use under terms of MIT license */
;
!function(ad, ah, al) {
    function ap(a) {
        if (au = ah.documentElement,
        ay = ah.body,
        bu(),
        aI = this,
        a = a || {},
        ...
        aY = a.forceHeight !== !1,
        aY && (aV = a.scale || 1),
        a6 = a.mobileDeceleration || bK,
        bf = a.smoothScrolling !== !1,
        bj = a.smoothScrollingDuration || ae,
        bn = {
            targetTop: aI.getScrollTop()
        },
        bs = (a.mobileCheck || function() {
            return /Android|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent || navigator.vendor || ad.opera)
        }
        )(),
        bs ? (aQ = ah.getElementById(a.skrollrBody || bN),
        aQ && aE(),
        bI(),
        ax(au, [bp, bB], [bt])) : ax(au, [bp, bx], [bt]),
        aI.refresh(),
        bG(ad, "resize orientationchange", function() {
    ...
    }, a5 = /[\-+]?[\d]*\.?[\d]+/g, a9 = /\{\?\}/g, be = /rgba?\(\s*-?\d+\s*,\s*-?\d+\s*,\s*-?\d+/g, bi = /[a-z\-]+-gradient/g, bm = "", bq = "", bu = function() {
    ...
    ap.prototype.refresh = function(b) {
        ...
        aM = [],
        bo = 0,
        b = ah.getElementsByTagName("*")) : b.length === al && (b = [b]),
        c = 0,
        o = b.length; o > c; c++) {
            var B = b[c]
              , C = B
                            ...
                            if ("data-edge-strategy" !== J.name) {
                                if ("data-emit-events" !== J.name) {
                                    ...
                                    if (null !== K) {
                                        ...
                                        var N = K[2];
                                        /p$/.test(N) ? (L.isPercentage = !0,
                                        L.offset = (0 | N.slice(0, -1)) / 100) : L.offset = 0 | N;
                                        var O = K[3]
                                          , P = K[4] || O;
                                        O && O !== ai && O !== am ? (L.mode = "relative",
                                        L.anchors = [O, P]) : (L.mode = "absolute",
                                        O === am ? L.isEnd = !0 : L.isPercentage || (L.offset = L.offset * aV))
                                    }
                                } else {
                                    G = !0
                                }
    ...
    ap.prototype.animateTo = function(c, g) {
        ...
        bb.topDiff || (bb.done && bb.done.call(aI, !1),
        bb = al),
        aI
    }
    ,
    ap.prototype.stopAnimateTo = function() {
        bb && bb.done && bb.done.call(aI, !0),
        bb = al
    }
    ,
    ...
    ap.prototype.setScrollTop = function(a, d) {
        return br = d === !0,
        bs ? bw = aK.min(aK.max(a, 0), aR) : ad.scrollTo(0, a),
        aI
    }
    ,
    ...
    ap.prototype.destroy = function() {
        ...
        au.style.overflow = ay.style.overflow = "",
        au.style.height = ay.style.height = "",
        aQ && aC.setStyle(aQ, "transform", "none"),
        aI = al,
        aQ = al,
        aU = al,
        aY = al,
    ...
    var bI = function() {
        ...
        bG(au, [aS, aW, a0, a4].join(" "), function(d) {
            ...
            i = p.clientX,
            n = d.timeStamp,
            aD.test(e.tagName) || d.preventDefault(),
            d.type) {
            case aS:
                a && a.blur(),
                aI.stopAnimateTo(),
                ...
                break;
            case aW:
                aD.test(e.tagName) && ah.activeElement !== e && d.preventDefault(),
                l = f - k,
                x = n - w,
                aI.setScrollTop(bw - l, !0),
                k = f,
                w = n;
                break;
            default:
            ...
            case a4:
                ...
                if (49 > s) {
                    if (!aD.test(a.tagName)) {
                        ...
                        t.initMouseEvent("click", !0, !0, d.view, 1, p.screenX, p.screenY, p.clientX, p.clientY, d.ctrlKey, d.altKey, d.shiftKey, d.metaKey, 0, null),
                        a.dispatchEvent(t)
                    }
                    return
                }
        ...
        ad.scrollTo(0, 0),
        au.style.overflow = ay.style.overflow = "hidden"
    }
      , bL = function() {
        var e, i, p, q, r, s, t, u, v, w, x, y = au.clientHeight, z = ak();
        for (u = 0,
        v = aM.length; v > u; u++) {
            for (e = aM[u],
            i = e.element,
            ...
            s = q.length; s > r; r++) {
                ...
                t.isPercentage && (w *= y,
                t.frame = w),
                "relative" === t.mode && (aA(i),
                t.frame = aI.relativeToAbsolute(p, t.anchors[0], t.anchors[1]) - w,
                aA(i, !0)),
                t.frame += x,
                aY && !t.isEnd && t.frame > aR && (aR = t.frame)
            }
        }
        for (aR = aK.max(aR, ao()),
        u = 0,
      ...
      , bO = function(g, o) {
        for (var q = 0, D = aM.length; D > q; q++) {
            var E, F, G = aM[q], H = G.element, I = G.smoothScrolling ? g : o, J = G.keyFrames, K = J.length, L = J[0], M = J[J.length - 1], N = I < L.frame, O = I > M.frame, P = N ? L : M, Q = G.emitEvents, R = G.lastFrameIndex;
            if (N || O) {
                if (N && -1 === G.edge || O && 1 === G.edge) {
                    continue
                }
                switch (N ? (ax(H, [bd], [bl, bh]),
                Q && R > -1 && (bP(H, L.eventType, aZ),
                G.lastFrameIndex = -1)) : (ax(H, [bl], [bd, bh]),
                Q && K > R && (bP(H, M.eventType, aZ),
                G.lastFrameIndex = K)),
                G.edge = N ? -1 : 1,
                G.edgeStrategy) {
                case "reset":
                ...
                if (I >= J[T].frame && I <= J[T + 1].frame) {
                    ...
                    for (E in h.props) {
                        if (aG.call(h.props, E)) {
                            ...
                            r = h.props[E].easing(r),
                            F = ar(h.props[E].value, p.props[E].value, r),
                            F = aw(F),
                            0 === E.indexOf("@") ? H.setAttribute(E.substr(1), F) : aC.setStyle(H, E, F)
                        }
                    }
                    Q && R !== T && ("down" === aZ ? bP(H, h.eventType, aZ) : bP(H, p.eventType, aZ),
                    G.lastFrameIndex = T);
                    break
                }
            }
      ...
      , ab = function() {
        bk && (bk = !1,
        ag());
        var c, g, j = aI.getScrollTop(), k = aJ();
        if (bb) {
            k >= bb.endTime ? (j = bb.targetTop,
            c = bb.done,
            bb = al) : (g = bb.easing((k - bb.startTime) / bb.duration),
            j = bb.startTop + g * bb.topDiff | 0),
            aI.setScrollTop(j, !0)
        } else {
            if (!br) {
                ...
                k <= bn.endTime && (g = bF.sqrt((k - bn.startTime) / bj),
                j = bn.startTop + g * bn.topDiff | 0)
            }
        }
        if (br || a3 !== j) {
            aZ = j > a3 ? "down" : a3 > j ? "up" : aZ,
            br = !1;
            var m = {
                curTop: j,
                lastTop: a3,
            ...
            n !== !1 && (bO(j, aI.getScrollTop()),
            bs && aQ && aC.setStyle(aQ, "transform", "translate(0, " + -bw + "px) " + bz),
            a3 = j,
            aU.render && aU.render.call(aI, m)),
            c && c.call(aI, !1)
        }
        a7 = k
    }
      ...
      , af = function(c) {
        var d = [];
        return be.lastIndex = 0,
        c = c.replace(be, function(b) {
            return b.replace(a5, function(e) {
                return e / 255 * 100 + "%"
            })
        }),
        bq && (bi.lastIndex = 0,
        c = c.replace(bi, function(b) {
            return bq + b
        })),
      ...
      , aj = function(e) {
        var f, g, h = {};
        for (f = 0,
        g = e.keyFrames.length; g > f; f++) {
            an(e.keyFrames[f], h)
        }
        for (h = {},
        f = e.keyFrames.length - 1; f >= 0; f--) {
            an(e.keyFrames[f], h)
        }
    }
      , an = function(d, e) {
      ...
      , aw = function(c) {
        var d = 1;
        return a9.lastIndex = 0,
        c[0].replace(a9, function() {
            return c[d++]
        })
    }
      , aA = function(g, h) {
        ...
        for (var i, j, k = 0, l = g.length; l > k; k++) {
            j = g[k],
            i = aM[j[az]],
            i && (h ? (j.style.cssText = i.dirtyStyleAttr,
            ax(j, i.dirtyClassAttr)) : (i.dirtyStyleAttr = j.style.cssText,
            i.dirtyClassAttr = at(j),
            j.style.cssText = i.styleAttr,
            ax(j, i.classAttr)))
        }
    }
      , aE = function() {
        bz = "translateZ(0)",
        aC.setStyle(aQ, "transform", bz);
        var e = aO(aQ)
    ...
    aC.setStyle = function(f, g, h) {
        ...
        "zIndex" === g) {
            ...
            if ("float" === g) {
                ...
                try {
                    bm && (i[bm + g.slice(0, 1).toUpperCase() + g.slice(1)] = h),
                    i[g] = h
                } catch (j) {}
            }
        }
    ...
    var aI, aM, aQ, aU, aY, a2, a6, bb, bf, bj, bn, br, bv, bz, bD, bG = aC.addEvent = function(a, i, j) {
        ...
        for (var l, m = 0, n = i.length; n > m; m++) {
            l = i[m],
            a.addEventListener ? a.addEventListener(l, j, !1) : a.attachEvent("on" + l, k),
            bA.push({
                element: a,
                name: l,
                listener: j
    ...
    , bM = function() {
        for (var d, e = 0, f = bA.length; f > e; e++) {
            d = bA[e],
            bJ(d.element, d.name, d.listener)
        }
        bA = []
    }, bP = function(d, e, f) {
        ...
        aR = 0,
        aY && !bs && (ay.style.height = ""),
        bL(),
        aY && !bs && (ay.style.height = aR + au.clientHeight + "px"),
        bs ? aI.setScrollTop(aK.min(aI.getScrollTop(), aR)) : aI.setScrollTop(b, !0),
        br = !0
    }, ak = function() {
        var e, f, g = au.clientHeight, h = {};
        for (e in a2) {
            f = a2[e],
            "function" == typeof f ? f = f.call(aI) : /p$/.test(f) && (f = f.slice(0, -1) / 100 * g),
            h[e] = f
        }
        return h
    }, ao = function() {
        var c, d = 0;
        return aQ && (d = aK.max(aQ.offsetHeight, aQ.scrollHeight)),
        c = aK.max(d, ay.scrollHeight, ay.offsetHeight, au.scrollHeight, au.offsetHeight, au.clientHeight),
        c - au.clientHeight
    }, at = function(a) {
        var d = "className";
        return ad.SVGElement && a instanceof ad.SVGElement && (a = a[d],
        d = "baseVal"),
        a[d]
    }, ax = function(a, c, l) {
        var m = "className";
        if (ad.SVGElement && a instanceof ad.SVGElement && (a = a[m],
        m = "baseVal"),
        l === al) {
            return void (a[m] = c)
        }
    ...
    }, aR = 0, aV = 1, aZ = "down", a3 = -1, a7 = aJ(), bc = 0, bg = 0, bk = !1, bo = 0, bs = !1, bw = 0, bA = [];
...
!function() {
    var c, b = function(al, W) {
        ...
        function af() {
            ...
            i.attr("data-swiper-autoplay") && (k = i.attr("data-swiper-autoplay") || an.params.autoplay),
            an.autoplayTimeoutId = setTimeout(function() {
                an.params.loop ? (an.fixLoop(),
                an._slideNext(),
                an.emit("onAutoplay", an)) : an.isEnd ? W.autoplayStopOnLast ? an.stopAutoplay() : (an._slideTo(0),
                an.emit("onAutoplay", an)) : (an._slideNext(),
                an.emit("onAutoplay", an))
            }, k)
        }
        function ag(k, n) {
            var m = c(k.target);
        ...
        function ai(m) {
            ...
            if (!(m.shiftKey || m.altKey || m.ctrlKey || m.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                if (37 === k || 39 === k || 38 === k || 40 === k) {
                    var B = !1;
                    if (an.container.parents("." + an.params.slideClass).length > 0 && 0 === an.container.parents("." + an.params.slideActiveClass).length) {
                        return
                    }
                    var A = {
                    ...
                    for (var x = [[w.left, w.top], [w.left + an.width, w.top], [w.left, w.top + an.height], [w.left + an.width, w.top + an.height]], v = 0; v < x.length; v++) {
                        var y = x[v];
                ...
                an.isHorizontal() ? (37 !== k && 39 !== k || (m.preventDefault ? m.preventDefault() : m.returnValue = !1),
                (39 === k && !an.rtl || 37 === k && an.rtl) && an.slideNext(),
                (37 === k && !an.rtl || 39 === k && an.rtl) && an.slidePrev()) : (38 !== k && 40 !== k || (m.preventDefault ? m.preventDefault() : m.returnValue = !1),
                40 === k && an.slideNext(),
                38 === k && an.slidePrev()),
                an.emit("onKeyPress", an, k)
            }
        }
        function F(l) {
            var k = 0
              ...
              , n = 0
              , m = 0;
            return "detail"in l && (o = l.detail),
            "wheelDelta"in l && (o = -l.wheelDelta / 120),
            "wheelDeltaY"in l && (o = -l.wheelDeltaY / 120),
            "wheelDeltaX"in l && (k = -l.wheelDeltaX / 120),
            "axis"in l && l.axis === l.HORIZONTAL_AXIS && (k = o,
            o = 0),
            n = 10 * k,
            m = 10 * o,
            "deltaY"in l && (m = l.deltaY),
            "deltaX"in l && (n = l.deltaX),
            (n || m) && l.deltaMode && (1 === l.deltaMode ? (n *= 40,
            m *= 40) : (n *= 800,
            m *= 800)),
            n && !k && (k = n < 1 ? -1 : 1),
            m && !o && (o = m < 1 ? -1 : 1),
        ...
        function ao(l) {
            ...
            if (0 !== k) {
                if (an.params.mousewheelInvert && (k = -k),
                an.params.freeMode) {
                    var m = an.getWrapperTranslate() + k * an.params.mousewheelSensitivity
                      , p = an.isBeginning
                      , o = an.isEnd;
                    if (m >= an.minTranslate() && (m = an.minTranslate()),
                    m <= an.maxTranslate() && (m = an.maxTranslate()),
                    an.setWrapperTransition(0),
                    an.setWrapperTranslate(m),
                    an.updateProgress(),
                    an.updateActiveIndex(),
                    (!p && an.isBeginning || !o && an.isEnd) && an.updateClasses(),
                    an.params.freeModeSticky ? (clearTimeout(an.mousewheel.timeout),
                    an.mousewheel.timeout = setTimeout(function() {
                        an.slideReset()
                    }, 300)) : an.params.lazyLoading && an.lazy && an.lazy.load(),
                    an.emit("onScroll", an, l),
                    an.params.autoplay && an.params.autoplayDisableOnInteraction && an.stopAutoplay(),
        ...
        function q(k, u) {
            ...
            p = k.attr("data-swiper-parallax") || "0",
            l = k.attr("data-swiper-parallax-x"),
            o = k.attr("data-swiper-parallax-y"),
            l || o ? (l = l || "0",
            o = o || "0") : an.isHorizontal() ? (l = p,
            o = "0") : (o = p,
            l = "0"),
            l = l.indexOf("%") >= 0 ? parseInt(l, 10) * u * m + "%" : l * u * m + "px",
            o = o.indexOf("%") >= 0 ? parseInt(o, 10) * u + "%" : o * u + "px",
            k.transform("translate3d(" + l + ", " + o + ",0px)")
        }
        function ad(i) {
            return 0 !== i.indexOf("on") && (i = i[0] !== i[0].toUpperCase() ? "on" + i[0].toUpperCase() + i.substring(1) : "on" + i),
            i
        }
        ...
        var N = {};
        for (var ap in W) {
            if ("object" != typeof W[ap] || null === W[ap] || (W[ap].nodeType || W[ap] === window || W[ap] === document || void 0 !== h && W[ap]instanceof h || "undefined" != typeof jQuery && W[ap]instanceof jQuery)) {
                N[ap] = W[ap]
            } else {
                N[ap] = {};
                for (var aq in W[ap]) {
        ...
        an.originalParams = N,
        an.classNames = [],
        void 0 !== c && void 0 !== h && (c = h),
        (void 0 !== c || (c = void 0 === h ? window.Dom7 || window.Zepto || window.jQuery : h)) && (an.$ = c,
        an.currentBreakpoint = void 0,
        an.getActiveBreakpoint = function() {
        ...
        an.setBreakpoint = function() {
            ...
            if (k && an.currentBreakpoint !== k) {
                ...
                an.currentBreakpoint = k,
                m && an.destroyLoop && an.reLoop(!0)
            }
        }
        ,
        an.params.breakpoints && an.setBreakpoint(),
        an.container = c(al),
        0 !== an.container.length)) {
            ...
            an.container[0].swiper = an,
            an.container.data("swiper", an),
            an.classNames.push(an.params.containerModifierClass + an.params.direction),
            an.params.freeMode && an.classNames.push(an.params.containerModifierClass + "free-mode"),
            an.support.flexbox || (an.classNames.push(an.params.containerModifierClass + "no-flexbox"),
            an.params.slidesPerColumn = 1),
            an.params.autoHeight && an.classNames.push(an.params.containerModifierClass + "autoheight"),
            (an.params.parallax || an.params.watchSlidesVisibility) && (an.params.watchSlidesProgress = !0),
            an.params.touchReleaseOnEdges && (an.params.resistanceRatio = 0),
            ["cube", "coverflow", "flip"].indexOf(an.params.effect) >= 0 && (an.support.transforms3d ? (an.params.watchSlidesProgress = !0,
            an.classNames.push(an.params.containerModifierClass + "3d")) : an.params.effect = "slide"),
            "slide" !== an.params.effect && an.classNames.push(an.params.containerModifierClass + an.params.effect),
            "cube" === an.params.effect && (an.params.resistanceRatio = 0,
            an.params.slidesPerView = 1,
            an.params.slidesPerColumn = 1,
            an.params.slidesPerGroup = 1,
            an.params.centeredSlides = !1,
            an.params.spaceBetween = 0,
            an.params.virtualTranslate = !0),
            "fade" !== an.params.effect && "flip" !== an.params.effect || (an.params.slidesPerView = 1,
            an.params.slidesPerColumn = 1,
            an.params.slidesPerGroup = 1,
            an.params.watchSlidesProgress = !0,
            an.params.spaceBetween = 0,
            void 0 === Q && (an.params.virtualTranslate = !0)),
            an.params.grabCursor && an.support.touch && (an.params.grabCursor = !1),
            an.wrapper = an.container.children("." + an.params.wrapperClass),
            an.params.pagination && (an.paginationContainer = c(an.params.pagination),
            an.params.uniqueNavElements && "string" == typeof an.params.pagination && an.paginationContainer.length > 1 && 1 === an.container.find(an.params.pagination).length && (an.paginationContainer = an.container.find(an.params.pagination)),
            "bullets" === an.params.paginationType && an.params.paginationClickable ? an.paginationContainer.addClass(an.params.paginationModifierClass + "clickable") : an.params.paginationClickable = !1,
            an.paginationContainer.addClass(an.params.paginationModifierClass + an.params.paginationType)),
            (an.params.nextButton || an.params.prevButton) && (an.params.nextButton && (an.nextButton = c(an.params.nextButton),
            an.params.uniqueNavElements && "string" == typeof an.params.nextButton && an.nextButton.length > 1 && 1 === an.container.find(an.params.nextButton).length && (an.nextButton = an.container.find(an.params.nextButton))),
            an.params.prevButton && (an.prevButton = c(an.params.prevButton),
            an.params.uniqueNavElements && "string" == typeof an.params.prevButton && an.prevButton.length > 1 && 1 === an.container.find(an.params.prevButton).length && (an.prevButton = an.container.find(an.params.prevButton)))),
            an.isHorizontal = function() {
                return "horizontal" === an.params.direction
            }
            ,
            an.rtl = an.isHorizontal() && ("rtl" === an.container[0].dir.toLowerCase() || "rtl" === an.container.css("direction")),
            an.rtl && an.classNames.push(an.params.containerModifierClass + "rtl"),
            an.rtl && (an.wrongRTL = "-webkit-box" === an.wrapper.css("display")),
            an.params.slidesPerColumn > 1 && an.classNames.push(an.params.containerModifierClass + "multirow"),
            an.device.android && an.classNames.push(an.params.containerModifierClass + "android"),
            an.container.addClass(an.classNames.join(" ")),
            an.translate = 0,
            an.progress = 0,
            an.velocity = 0,
            an.lockSwipeToNext = function() {
                an.params.allowSwipeToNext = !1,
                an.params.allowSwipeToPrev === !1 && an.params.grabCursor && an.unsetGrabCursor()
            }
            ,
            an.lockSwipeToPrev = function() {
                an.params.allowSwipeToPrev = !1,
                an.params.allowSwipeToNext === !1 && an.params.grabCursor && an.unsetGrabCursor()
            }
            ,
            an.lockSwipes = function() {
                an.params.allowSwipeToNext = an.params.allowSwipeToPrev = !1,
                an.params.grabCursor && an.unsetGrabCursor()
            }
            ,
            an.unlockSwipeToNext = function() {
                an.params.allowSwipeToNext = !0,
                an.params.allowSwipeToPrev === !0 && an.params.grabCursor && an.setGrabCursor()
            }
            ,
            an.unlockSwipeToPrev = function() {
                an.params.allowSwipeToPrev = !0,
                an.params.allowSwipeToNext === !0 && an.params.grabCursor && an.setGrabCursor()
            }
            ,
            an.unlockSwipes = function() {
                an.params.allowSwipeToNext = an.params.allowSwipeToPrev = !0,
                an.params.grabCursor && an.setGrabCursor()
            }
            ,
            an.setGrabCursor = function(i) {
                an.container[0].style.cursor = "move",
                an.container[0].style.cursor = i ? "-webkit-grabbing" : "-webkit-grab",
                an.container[0].style.cursor = i ? "-moz-grabbin" : "-moz-grab",
                an.container[0].style.cursor = i ? "grabbing" : "grab"
            }
            ,
            ...
            an.imagesToLoad = [],
            an.imagesLoaded = 0,
            an.loadImage = function(l, k, x, w, m, v) {
                function p() {
                    v && v()
                }
                var u;
                l.complete && m ? p() : k ? (u = new window.Image,
                u.onload = p,
                u.onerror = p,
                w && (u.sizes = w),
                x && (u.srcset = x),
            ...
            an.preloadImages = function() {
                function k() {
                    void 0 !== an && null !== an && an && (void 0 !== an.imagesLoaded && an.imagesLoaded++,
                    an.imagesLoaded === an.imagesToLoad.length && (an.params.updateOnImagesReady && an.update(),
                    an.emit("onImagesReady", an)))
                }
                an.imagesToLoad = an.container.find("img");
                for (var i = 0; i < an.imagesToLoad.length; i++) {
                    an.loadImage(an.imagesToLoad[i], an.imagesToLoad[i].currentSrc || an.imagesToLoad[i].getAttribute("src"), an.imagesToLoad[i].srcset || an.imagesToLoad[i].getAttribute("srcset"), an.imagesToLoad[i].sizes || an.imagesToLoad[i].getAttribute("sizes"), !0, k)
                }
            }
            ,
            an.autoplayTimeoutId = void 0,
            an.autoplaying = !1,
            an.autoplayPaused = !1,
            an.startAutoplay = function() {
                return void 0 === an.autoplayTimeoutId && (!!an.params.autoplay && (!an.autoplaying && (an.autoplaying = !0,
                an.emit("onAutoplayStart", an),
                void af())))
            }
            ,
            an.stopAutoplay = function(i) {
                an.autoplayTimeoutId && (an.autoplayTimeoutId && clearTimeout(an.autoplayTimeoutId),
                an.autoplaying = !1,
                an.autoplayTimeoutId = void 0,
                an.emit("onAutoplayStop", an))
            }
            ,
            an.pauseAutoplay = function(i) {
                an.autoplayPaused || (an.autoplayTimeoutId && clearTimeout(an.autoplayTimeoutId),
                an.autoplayPaused = !0,
                0 === i ? (an.autoplayPaused = !1,
                af()) : an.wrapper.transitionEnd(function() {
                    an && (an.autoplayPaused = !1,
                    an.autoplaying ? af() : an.stopAutoplay())
                }))
            }
            ,
            ...
            an.updateContainerSize = function() {
                var k, i;
                k = void 0 !== an.params.width ? an.params.width : an.container[0].clientWidth,
                i = void 0 !== an.params.height ? an.params.height : an.container[0].clientHeight,
                0 === k && an.isHorizontal() || 0 === i && !an.isHorizontal() || (k = k - parseInt(an.container.css("padding-left"), 10) - parseInt(an.container.css("padding-right"), 10),
                i = i - parseInt(an.container.css("padding-top"), 10) - parseInt(an.container.css("padding-bottom"), 10),
                an.width = k,
                an.height = i,
                an.size = an.isHorizontal() ? an.width : an.height)
            }
            ,
            an.updateSlidesSize = function() {
                an.slides = an.wrapper.children("." + an.params.slideClass),
                an.snapGrid = [],
                an.slidesGrid = [],
                an.slidesSizesGrid = [];
                var w, k = an.params.spaceBetween, H = -an.params.slidesOffsetBefore, G = 0, z = 0;
                if (void 0 !== an.size) {
                    "string" == typeof k && k.indexOf("%") >= 0 && (k = parseFloat(k.replace("%", "")) / 100 * an.size),
                    an.virtualSize = -k,
                    an.rtl ? an.slides.css({
                        marginLeft: "",
                        marginTop: ""
                    }) : an.slides.css({
                        marginRight: "",
                    ...
                    var C;
                    an.params.slidesPerColumn > 1 && (C = Math.floor(an.slides.length / an.params.slidesPerColumn) === an.slides.length / an.params.slidesPerColumn ? an.slides.length : Math.ceil(an.slides.length / an.params.slidesPerColumn) * an.params.slidesPerColumn,
                    "auto" !== an.params.slidesPerView && "row" === an.params.slidesPerColumnFill && (C = Math.max(C, an.params.slidesPerView * an.params.slidesPerColumn)));
                    var D, A = an.params.slidesPerColumn, E = C / A, v = E - (an.params.slidesPerColumn * E - an.slides.length);
                    for (w = 0; w < an.slides.length; w++) {
                        D = 0;
                        var I = an.slides.eq(w);
                        if (an.params.slidesPerColumn > 1) {
                            var r, B, y;
                            "column" === an.params.slidesPerColumnFill ? (B = Math.floor(w / A),
                            y = w - B * A,
                            (B > v || B === v && y === A - 1) && ++y >= A && (y = 0,
                            B++),
                            r = B + y * C / A,
                            I.css({
                            ...
                            B = w - y * E),
                            I.css("margin-" + (an.isHorizontal() ? "top" : "left"), 0 !== y && an.params.spaceBetween && an.params.spaceBetween + "px").attr("data-swiper-column", B).attr("data-swiper-row", y)
                        }
                        "none" !== I.css("display") && ("auto" === an.params.slidesPerView ? (D = an.isHorizontal() ? I.outerWidth(!0) : I.outerHeight(!0),
                        an.params.roundLengths && (D = ak(D))) : (D = (an.size - (an.params.slidesPerView - 1) * k) / an.params.slidesPerView,
                        an.params.roundLengths && (D = ak(D)),
                        an.isHorizontal() ? an.slides[w].style.width = D + "px" : an.slides[w].style.height = D + "px"),
                        an.slides[w].swiperSlideSize = D,
                        an.slidesSizesGrid.push(D),
                        an.params.centeredSlides ? (H = H + D / 2 + G / 2 + k,
                        0 === G && 0 !== w && (H = H - an.size / 2 - k),
                        0 === w && (H = H - an.size / 2 - k),
                        Math.abs(H) < 0.001 && (H = 0),
                        z % an.params.slidesPerGroup == 0 && an.snapGrid.push(H),
                        an.slidesGrid.push(H)) : (z % an.params.slidesPerGroup == 0 && an.snapGrid.push(H),
                        an.slidesGrid.push(H),
                        H = H + D + k),
                        an.virtualSize += D + k,
                        G = D,
                        z++)
                    ...
                    var x;
                    if (an.rtl && an.wrongRTL && ("slide" === an.params.effect || "coverflow" === an.params.effect) && an.wrapper.css({
                        width: an.virtualSize + an.params.spaceBetween + "px"
                    }),
                    an.support.flexbox && !an.params.setWrapperSize || (an.isHorizontal() ? an.wrapper.css({
                        width: an.virtualSize + an.params.spaceBetween + "px"
                    }) : an.wrapper.css({
                        height: an.virtualSize + an.params.spaceBetween + "px"
                    })),
                    an.params.slidesPerColumn > 1 && (an.virtualSize = (D + an.params.spaceBetween) * C,
                    an.virtualSize = Math.ceil(an.virtualSize / an.params.slidesPerColumn) - an.params.spaceBetween,
                    an.isHorizontal() ? an.wrapper.css({
                        width: an.virtualSize + an.params.spaceBetween + "px"
                    }) : an.wrapper.css({
                        height: an.virtualSize + an.params.spaceBetween + "px"
                    }),
                    ...
                    if (!an.params.centeredSlides) {
                        ...
                        an.snapGrid = x,
                        Math.floor(an.virtualSize - an.size) - Math.floor(an.snapGrid[an.snapGrid.length - 1]) > 1 && an.snapGrid.push(an.virtualSize - an.size)
                    }
                    0 === an.snapGrid.length && (an.snapGrid = [0]),
                    0 !== an.params.spaceBetween && (an.isHorizontal() ? an.rtl ? an.slides.css({
                        marginLeft: k + "px"
                    }) : an.slides.css({
                        marginRight: k + "px"
                    }) : an.slides.css({
            ...
            an.updateSlidesOffset = function() {
                for (var i = 0; i < an.slides.length; i++) {
                    an.slides[i].swiperSlideOffset = an.isHorizontal() ? an.slides[i].offsetLeft : an.slides[i].offsetTop
                }
            }
            ,
            an.currentSlidesPerView = function() {
                ...
                if (an.params.centeredSlides) {
                    ...
                    for (l = an.activeIndex + 1; l < an.slides.length; l++) {
                        an.slides[l] && !n && (m += an.slides[l].swiperSlideSize,
                        o++,
                        m > an.size && (n = !0))
                    }
                    for (k = an.activeIndex - 1; k >= 0; k--) {
                        an.slides[k] && !n && (m += an.slides[k].swiperSlideSize,
                        o++,
                        m > an.size && (n = !0))
                    }
                } else {
            ...
            an.updateSlidesProgress = function(l) {
                if (void 0 === l && (l = an.translate || 0),
                0 !== an.slides.length) {
                    void 0 === an.slides[0].swiperSlideOffset && an.updateSlidesOffset();
                    var k = -l;
                    an.rtl && (k = l),
                    an.slides.removeClass(an.params.slideVisibleClass);
                    for (var v = 0; v < an.slides.length; v++) {
                        var u = an.slides[v]
                          , m = (k + (an.params.centeredSlides ? an.minTranslate() : 0) - u.swiperSlideOffset) / (u.swiperSlideSize + an.params.spaceBetween);
                        if (an.params.watchSlidesVisibility) {
                            var p = -(k - u.swiperSlideOffset)
                              , o = p + an.slidesSizesGrid[v];
                            (p >= 0 && p < an.size || o > 0 && o <= an.size || p <= 0 && o >= an.size) && an.slides.eq(v).addClass(an.params.slideVisibleClass)
                        }
            ...
            an.updateProgress = function(k) {
                ...
                var i = an.maxTranslate() - an.minTranslate()
                  ...
                  , l = an.isEnd;
                0 === i ? (an.progress = 0,
                an.isBeginning = an.isEnd = !0) : (an.progress = (k - an.minTranslate()) / i,
                an.isBeginning = an.progress <= 0,
                an.isEnd = an.progress >= 1),
                an.isBeginning && !m && an.emit("onReachBeginning", an),
                an.isEnd && !l && an.emit("onReachEnd", an),
                an.params.watchSlidesProgress && an.updateSlidesProgress(k),
                an.emit("onProgress", an, an.progress)
            }
            ,
            an.updateActiveIndex = function() {
                var k, i, m, l = an.rtl ? an.translate : -an.translate;
                for (i = 0; i < an.slidesGrid.length; i++) {
                    void 0 !== an.slidesGrid[i + 1] ? l >= an.slidesGrid[i] && l < an.slidesGrid[i + 1] - (an.slidesGrid[i + 1] - an.slidesGrid[i]) / 2 ? k = i : l >= an.slidesGrid[i] && l < an.slidesGrid[i + 1] && (k = i + 1) : l >= an.slidesGrid[i] && (k = i)
                }
                an.params.normalizeSlideIndex && (k < 0 || void 0 === k) && (k = 0),
                m = Math.floor(k / an.params.slidesPerGroup),
                m >= an.snapGrid.length && (m = an.snapGrid.length - 1),
                k !== an.activeIndex && (an.snapIndex = m,
                an.previousIndex = an.activeIndex,
                an.activeIndex = k,
                an.updateClasses(),
                an.updateRealIndex())
            }
            ...
            an.updateRealIndex = function() {
                an.realIndex = parseInt(an.slides.eq(an.activeIndex).attr("data-swiper-slide-index") || an.activeIndex, 10)
            }
            ,
            an.updateClasses = function() {
                an.slides.removeClass(an.params.slideActiveClass + " " + an.params.slideNextClass + " " + an.params.slidePrevClass + " " + an.params.slideDuplicateActiveClass + " " + an.params.slideDuplicateNextClass + " " + an.params.slideDuplicatePrevClass);
                var i = an.slides.eq(an.activeIndex);
                i.addClass(an.params.slideActiveClass),
                W.loop && (i.hasClass(an.params.slideDuplicateClass) ? an.wrapper.children("." + an.params.slideClass + ":not(." + an.params.slideDuplicateClass + ')[data-swiper-slide-index="' + an.realIndex + '"]').addClass(an.params.slideDuplicateActiveClass) : an.wrapper.children("." + an.params.slideClass + "." + an.params.slideDuplicateClass + '[data-swiper-slide-index="' + an.realIndex + '"]').addClass(an.params.slideDuplicateActiveClass));
                var y = i.next("." + an.params.slideClass).addClass(an.params.slideNextClass);
                an.params.loop && 0 === y.length && (y = an.slides.eq(0),
                y.addClass(an.params.slideNextClass));
                var x = i.prev("." + an.params.slideClass).addClass(an.params.slidePrevClass);
                if (an.params.loop && 0 === x.length && (x = an.slides.eq(-1),
                x.addClass(an.params.slidePrevClass)),
                W.loop && (y.hasClass(an.params.slideDuplicateClass) ? an.wrapper.children("." + an.params.slideClass + ":not(." + an.params.slideDuplicateClass + ')[data-swiper-slide-index="' + y.attr("data-swiper-slide-index") + '"]').addClass(an.params.slideDuplicateNextClass) : an.wrapper.children("." + an.params.slideClass + "." + an.params.slideDuplicateClass + '[data-swiper-slide-index="' + y.attr("data-swiper-slide-index") + '"]').addClass(an.params.slideDuplicateNextClass),
                x.hasClass(an.params.slideDuplicateClass) ? an.wrapper.children("." + an.params.slideClass + ":not(." + an.params.slideDuplicateClass + ')[data-swiper-slide-index="' + x.attr("data-swiper-slide-index") + '"]').addClass(an.params.slideDuplicatePrevClass) : an.wrapper.children("." + an.params.slideClass + "." + an.params.slideDuplicateClass + '[data-swiper-slide-index="' + x.attr("data-swiper-slide-index") + '"]').addClass(an.params.slideDuplicatePrevClass)),
                an.paginationContainer && an.paginationContainer.length > 0) {
                    var w, m = an.params.loop ? Math.ceil((an.slides.length - 2 * an.loopedSlides) / an.params.slidesPerGroup) : an.snapGrid.length;
                    if (an.params.loop ? (w = Math.ceil((an.activeIndex - an.loopedSlides) / an.params.slidesPerGroup),
                    w > an.slides.length - 1 - 2 * an.loopedSlides && (w -= an.slides.length - 2 * an.loopedSlides),
                    w > m - 1 && (w -= m),
                    w < 0 && "bullets" !== an.params.paginationType && (w = m + w)) : w = void 0 !== an.snapIndex ? an.snapIndex : an.activeIndex || 0,
                    "bullets" === an.params.paginationType && an.bullets && an.bullets.length > 0 && (an.bullets.removeClass(an.params.bulletActiveClass),
                    an.paginationContainer.length > 1 ? an.bullets.each(function() {
                        c(this).index() === w && c(this).addClass(an.params.bulletActiveClass)
                    }) : an.bullets.eq(w).addClass(an.params.bulletActiveClass)),
                    "fraction" === an.params.paginationType && (an.paginationContainer.find("." + an.params.paginationCurrentClass).text(w + 1),
                    an.paginationContainer.find("." + an.params.paginationTotalClass).text(m)),
                    "progress" === an.params.paginationType) {
                        var u = (w + 1) / m
                          , k = u
                          , v = 1;
                        an.isHorizontal() || (v = u,
                        k = 1),
                        an.paginationContainer.find("." + an.params.paginationProgressbarClass).transform("translate3d(0,0,0) scaleX(" + k + ") scaleY(" + v + ")").transition(an.params.speed)
                    }
                    "custom" === an.params.paginationType && an.params.paginationCustomRender && (an.paginationContainer.html(an.params.paginationCustomRender(an, w + 1, m)),
                    an.emit("onPaginationRendered", an, an.paginationContainer[0]))
                }
                an.params.loop || (an.params.prevButton && an.prevButton && an.prevButton.length > 0 && (an.isBeginning ? (an.prevButton.addClass(an.params.buttonDisabledClass),
                an.params.a11y && an.a11y && an.a11y.disable(an.prevButton)) : (an.prevButton.removeClass(an.params.buttonDisabledClass),
                an.params.a11y && an.a11y && an.a11y.enable(an.prevButton))),
                an.params.nextButton && an.nextButton && an.nextButton.length > 0 && (an.isEnd ? (an.nextButton.addClass(an.params.buttonDisabledClass),
                an.params.a11y && an.a11y && an.a11y.disable(an.nextButton)) : (an.nextButton.removeClass(an.params.buttonDisabledClass),
                an.params.a11y && an.a11y && an.a11y.enable(an.nextButton))))
            }
            ,
            an.updatePagination = function() {
                if (an.params.pagination && an.paginationContainer && an.paginationContainer.length > 0) {
                    ...
                    if ("bullets" === an.params.paginationType) {
                        for (var i = an.params.loop ? Math.ceil((an.slides.length - 2 * an.loopedSlides) / an.params.slidesPerGroup) : an.snapGrid.length, l = 0; l < i; l++) {
                            k += an.params.paginationBulletRender ? an.params.paginationBulletRender(an, l, an.params.bulletClass) : "<" + an.params.paginationElement + ' class="' + an.params.bulletClass + '"></' + an.params.paginationElement + ">"
                        }
                        an.paginationContainer.html(k),
                        an.bullets = an.paginationContainer.find("." + an.params.bulletClass),
                        an.params.paginationClickable && an.params.a11y && an.a11y && an.a11y.initPagination()
                    }
                    "fraction" === an.params.paginationType && (k = an.params.paginationFractionRender ? an.params.paginationFractionRender(an, an.params.paginationCurrentClass, an.params.paginationTotalClass) : '<span class="' + an.params.paginationCurrentClass + '"></span> / <span class="' + an.params.paginationTotalClass + '"></span>',
                    an.paginationContainer.html(k)),
                    "progress" === an.params.paginationType && (k = an.params.paginationProgressRender ? an.params.paginationProgressRender(an, an.params.paginationProgressbarClass) : '<span class="' + an.params.paginationProgressbarClass + '"></span>',
                    an.paginationContainer.html(k)),
                    "custom" !== an.params.paginationType && an.emit("onPaginationRendered", an, an.paginationContainer[0])
                }
            }
            ,
            an.update = function(k) {
                function i() {
                    an.rtl,
                    an.translate;
                    l = Math.min(Math.max(an.translate, an.maxTranslate()), an.minTranslate()),
                    an.setWrapperTranslate(l),
                    an.updateActiveIndex(),
                    an.updateClasses()
                }
                if (an) {
                    an.updateContainerSize(),
                    an.updateSlidesSize(),
                    an.updateProgress(),
                    an.updatePagination(),
                    an.updateClasses(),
                    an.params.scrollbar && an.scrollbar && an.scrollbar.set();
                    var l;
                    if (k) {
                        an.controller && an.controller.spline && (an.controller.spline = void 0),
                        an.params.freeMode ? (i(),
                        an.params.autoHeight && an.updateAutoHeight()) : (("auto" === an.params.slidesPerView || an.params.slidesPerView > 1) && an.isEnd && !an.params.centeredSlides ? an.slideTo(an.slides.length - 1, 0, !1, !0) : an.slideTo(an.activeIndex, 0, !1, !0)) || i()
                    } else {
            ...
            an.onResize = function(l) {
                an.params.onBeforeResize && an.params.onBeforeResize(an),
                an.params.breakpoints && an.setBreakpoint();
                var k = an.params.allowSwipeToPrev
                  , o = an.params.allowSwipeToNext;
                an.params.allowSwipeToPrev = an.params.allowSwipeToNext = !0,
                an.updateContainerSize(),
                an.updateSlidesSize(),
                ("auto" === an.params.slidesPerView || an.params.freeMode || l) && an.updatePagination(),
                an.params.scrollbar && an.scrollbar && an.scrollbar.set(),
                an.controller && an.controller.spline && (an.controller.spline = void 0);
                var n = !1;
                if (an.params.freeMode) {
                    ...
                    an.updateClasses(),
                    n = ("auto" === an.params.slidesPerView || an.params.slidesPerView > 1) && an.isEnd && !an.params.centeredSlides ? an.slideTo(an.slides.length - 1, 0, !1, !0) : an.slideTo(an.activeIndex, 0, !1, !0)
                }
                an.params.lazyLoading && !n && an.lazy && an.lazy.load(),
                an.params.allowSwipeToPrev = k,
                an.params.allowSwipeToNext = o,
                an.params.onAfterResize && an.params.onAfterResize(an)
            }
            ,
            ...
            an.touchEvents = {
                start: an.support.touch || !an.params.simulateTouch ? "touchstart" : an.touchEventsDesktop.start,
            ...
            (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) && ("container" === an.params.touchEventsTarget ? an.container : an.wrapper).addClass("swiper-wp8-" + an.params.direction),
            an.initEvents = function(k) {
                var i = k ? "off" : "on"
                  ...
                  , l = !!an.params.nested;
                if (an.browser.ie) {
                    u[v](an.touchEvents.start, an.onTouchStart, !1),
                    p[v](an.touchEvents.move, an.onTouchMove, l),
                    p[v](an.touchEvents.end, an.onTouchEnd, !1)
                } else {
                    if (an.support.touch) {
                        var m = !("touchstart" !== an.touchEvents.start || !an.support.passiveListener || !an.params.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        };
                        u[v](an.touchEvents.start, an.onTouchStart, m),
                        u[v](an.touchEvents.move, an.onTouchMove, l),
                        u[v](an.touchEvents.end, an.onTouchEnd, m)
                    }
                    (W.simulateTouch && !an.device.ios && !an.device.android || W.simulateTouch && !an.support.touch && an.device.ios) && (u[v]("mousedown", an.onTouchStart, !1),
                    document[v]("mousemove", an.onTouchMove, l),
                    document[v]("mouseup", an.onTouchEnd, !1))
                }
                window[v]("resize", an.onResize),
                an.params.nextButton && an.nextButton && an.nextButton.length > 0 && (an.nextButton[i]("click", an.onClickNext),
                an.params.a11y && an.a11y && an.nextButton[i]("keydown", an.a11y.onEnterKey)),
                an.params.prevButton && an.prevButton && an.prevButton.length > 0 && (an.prevButton[i]("click", an.onClickPrev),
                an.params.a11y && an.a11y && an.prevButton[i]("keydown", an.a11y.onEnterKey)),
                an.params.pagination && an.params.paginationClickable && (an.paginationContainer[i]("click", "." + an.params.bulletClass, an.onClickIndex),
                an.params.a11y && an.a11y && an.paginationContainer[i]("keydown", "." + an.params.bulletClass, an.a11y.onEnterKey)),
                (an.params.preventClicks || an.params.preventClicksPropagation) && u[v]("click", an.preventClicks, !0)
            }
            ,
            ...
            ,
            an.allowClick = !0,
            an.preventClicks = function(i) {
                an.allowClick || (an.params.preventClicks && i.preventDefault(),
                an.params.preventClicksPropagation && an.animating && (i.stopPropagation(),
                i.stopImmediatePropagation()))
            }
            ,
            an.onClickNext = function(i) {
                i.preventDefault(),
                an.isEnd && !an.params.loop || an.slideNext()
            }
            ,
            an.onClickPrev = function(i) {
                i.preventDefault(),
                an.isBeginning && !an.params.loop || an.slidePrev()
            }
            ,
            an.onClickIndex = function(i) {
                i.preventDefault();
                var k = c(this).index() * an.params.slidesPerGroup;
                an.params.loop && (k += an.loopedSlides),
                an.slideTo(k)
            }
            ,
            an.updateClickedSlide = function(k) {
                ...
                if (!w || !v) {
                    return an.clickedSlide = void 0,
                    void (an.clickedIndex = void 0)
                }
                if (an.clickedSlide = w,
                an.clickedIndex = c(w).index(),
                an.params.slideToClickedSlide && void 0 !== an.clickedIndex && an.clickedIndex !== an.activeIndex) {
                    var u, p = an.clickedIndex, o = "auto" === an.params.slidesPerView ? an.currentSlidesPerView() : an.params.slidesPerView;
                    if (an.params.loop) {
                        if (an.animating) {
                            return
                        }
                        u = parseInt(c(an.clickedSlide).attr("data-swiper-slide-index"), 10),
                        an.params.centeredSlides ? p < an.loopedSlides - o / 2 || p > an.slides.length - an.loopedSlides + o / 2 ? (an.fixLoop(),
                        p = an.wrapper.children("." + an.params.slideClass + '[data-swiper-slide-index="' + u + '"]:not(.' + an.params.slideDuplicateClass + ")").eq(0).index(),
                        setTimeout(function() {
                            an.slideTo(p)
                        }, 0)) : an.slideTo(p) : p > an.slides.length - o ? (an.fixLoop(),
                        p = an.wrapper.children("." + an.params.slideClass + '[data-swiper-slide-index="' + u + '"]:not(.' + an.params.slideDuplicateClass + ")").eq(0).index(),
                        setTimeout(function() {
                            an.slideTo(p)
                        }, 0)) : an.slideTo(p)
            ...
            ;
            var am, t, aw, ae, K, aj, Z, aa, ac, J, j = "input, select, textarea, button, video", V = Date.now(), R = [];
            an.animating = !1,
            an.touches = {
                startX: 0,
                startY: 0,
            ...
            an.onTouchStart = function(k) {
                if (k.originalEvent && (k = k.originalEvent),
                (at = "touchstart" === k.type) || !("which"in k) || 3 !== k.which) {
                    ...
                    if (!an.params.swipeHandler || ag(k, an.params.swipeHandler)) {
                        var n = an.touches.currentX = "touchstart" === k.type ? k.targetTouches[0].pageX : k.pageX
                          , m = an.touches.currentY = "touchstart" === k.type ? k.targetTouches[0].pageY : k.pageY;
                        if (!(an.device.ios && an.params.iOSEdgeSwipeDetection && n <= an.params.iOSEdgeSwipeThreshold)) {
                            if (am = !0,
                            t = !1,
                            aw = !0,
                            K = void 0,
                            ...
                            an.allowClick = !0,
                            an.updateContainerSize(),
                            an.swipeDirection = void 0,
                            an.params.threshold > 0 && (aa = !1),
                            "touchstart" !== k.type) {
                                var l = !0;
                                c(k.target).is(j) && (l = !1),
                                document.activeElement && c(document.activeElement).is(j) && document.activeElement.blur(),
                                l && k.preventDefault()
                            }
            ...
            an.onTouchMove = function(i) {
                ...
                !at || "mousemove" !== i.type) {
                    if (i.preventedByNestedSwiper) {
                        ...
                        void (an.touches.startY = "touchmove" === i.type ? i.targetTouches[0].pageY : i.pageY)
                    }
                    if (an.params.onlyExternal) {
                        return an.allowClick = !1,
                        void (am && (an.touches.startX = an.touches.currentX = "touchmove" === i.type ? i.targetTouches[0].pageX : i.pageX,
                        an.touches.startY = an.touches.currentY = "touchmove" === i.type ? i.targetTouches[0].pageY : i.pageY,
                        ae = Date.now()))
                    }
                    if (at && an.params.touchReleaseOnEdges && !an.params.loop) {
                        if (an.isHorizontal()) {
                            if (an.touches.currentX < an.touches.startX && an.translate <= an.maxTranslate() || an.touches.currentX > an.touches.startX && an.translate >= an.minTranslate()) {
                                return
                            }
                        } else {
                            if (an.touches.currentY < an.touches.startY && an.translate <= an.maxTranslate() || an.touches.currentY > an.touches.startY && an.translate >= an.minTranslate()) {
                                return
                            }
                        }
                    }
                    if (at && document.activeElement && i.target === document.activeElement && c(i.target).is(j)) {
                        return t = !0,
                        void (an.allowClick = !1)
                    }
                    if (aw && an.emit("onTouchMove", an, i),
                    !(i.targetTouches && i.targetTouches.length > 1)) {
                        ...
                        void 0 === K) {
                            var m;
                            an.isHorizontal() && an.touches.currentY === an.touches.startY || !an.isHorizontal() && an.touches.currentX === an.touches.startX ? K = !1 : (m = 180 * Math.atan2(Math.abs(an.touches.currentY - an.touches.startY), Math.abs(an.touches.currentX - an.touches.startX)) / Math.PI,
                            K = an.isHorizontal() ? m > an.params.touchAngle : 90 - m > an.params.touchAngle)
                        }
                        if (K && an.emit("onTouchMoveOpposite", an, i),
                        void 0 === a && (an.touches.currentX === an.touches.startX && an.touches.currentY === an.touches.startY || (a = !0)),
                        am) {
                            if (K) {
                                return void (am = !1)
                            }
                            if (a) {
                                an.allowClick = !1,
                                an.emit("onSliderMove", an, i),
                                i.preventDefault(),
                                an.params.touchMoveStopPropagation && !an.params.nested && i.stopPropagation(),
                                t || (W.loop && an.fixLoop(),
                                Z = an.getWrapperTranslate(),
                                an.setWrapperTransition(0),
                                an.animating && an.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"),
                                an.params.autoplay && an.autoplaying && (an.params.autoplayDisableOnInteraction ? an.stopAutoplay() : an.pauseAutoplay()),
                                J = !1,
                                !an.params.grabCursor || an.params.allowSwipeToNext !== !0 && an.params.allowSwipeToPrev !== !0 || an.setGrabCursor(!0)),
                                t = !0;
                                var l = an.touches.diff = an.isHorizontal() ? an.touches.currentX - an.touches.startX : an.touches.currentY - an.touches.startY;
                                l *= an.params.touchRatio,
                                an.rtl && (l = -l),
                                an.swipeDirection = l > 0 ? "prev" : "next",
                                aj = l + Z;
                                var k = !0;
                                if (l > 0 && aj > an.minTranslate() ? (k = !1,
                                an.params.resistance && (aj = an.minTranslate() - 1 + Math.pow(-an.minTranslate() + Z + l, an.params.resistanceRatio))) : l < 0 && aj < an.maxTranslate() && (k = !1,
                                an.params.resistance && (aj = an.maxTranslate() + 1 - Math.pow(an.maxTranslate() - Z - l, an.params.resistanceRatio))),
                                k && (i.preventedByNestedSwiper = !0),
                                !an.params.allowSwipeToNext && "next" === an.swipeDirection && aj < Z && (aj = Z),
                                !an.params.allowSwipeToPrev && "prev" === an.swipeDirection && aj > Z && (aj = Z),
                                an.params.threshold > 0) {
                                    if (!(Math.abs(l) > an.params.threshold || aa)) {
                                        return void (aj = Z)
                                    }
                                    if (!aa) {
                                        return aa = !0,
                                        an.touches.startX = an.touches.currentX,
                                        an.touches.startY = an.touches.currentY,
                                        aj = Z,
                                        void (an.touches.diff = an.isHorizontal() ? an.touches.currentX - an.touches.startX : an.touches.currentY - an.touches.startY)
                                    }
                                }
                                an.params.followFinger && ((an.params.freeMode || an.params.watchSlidesProgress) && an.updateActiveIndex(),
                                an.params.freeMode && (0 === R.length && R.push({
                                    position: an.touches[an.isHorizontal() ? "startX" : "startY"],
                                    time: ae
                                }),
                                R.push({
                                    position: an.touches[an.isHorizontal() ? "currentX" : "currentY"],
                                    time: (new window.Date).getTime()
                                })),
                                an.updateProgress(aj),
                                an.setWrapperTranslate(aj))
                            }
                        }
                    }
                }
            ...
            an.onTouchEnd = function(k) {
                if (k.originalEvent && (k = k.originalEvent),
                aw && an.emit("onTouchEnd", an, k),
                aw = !1,
                am) {
                    an.params.grabCursor && t && am && (an.params.allowSwipeToNext === !0 || an.params.allowSwipeToPrev === !0) && an.setGrabCursor(!1);
                    var S = Date.now()
                      , P = S - ae;
                    if (an.allowClick && (an.updateClickedSlide(k),
                    an.emit("onTap", an, k),
                    P < 300 && S - V > 300 && (ac && clearTimeout(ac),
                    ac = setTimeout(function() {
                        an && (an.params.paginationHide && an.paginationContainer.length > 0 && !c(k.target).hasClass(an.params.bulletClass) && an.paginationContainer.toggleClass(an.params.paginationHiddenClass),
                        an.emit("onClick", an, k))
                    }, 300)),
                    P < 300 && S - V < 300 && (ac && clearTimeout(ac),
                    an.emit("onDoubleTap", an, k))),
                    V = Date.now(),
                    setTimeout(function() {
                        an && (an.allowClick = !0)
                    }, 0),
                    !am || !t || !an.swipeDirection || 0 === an.touches.diff || aj === Z) {
                        return void (am = t = !1)
                    }
                    am = t = !1;
                    var E;
                    if (E = an.params.followFinger ? an.rtl ? an.translate : -an.translate : -aj,
                    an.params.freeMode) {
                        if (E < -an.minTranslate()) {
                            return void an.slideTo(an.activeIndex)
                        }
                        if (E > -an.maxTranslate()) {
                            return void (an.slides.length < an.snapGrid.length ? an.slideTo(an.snapGrid.length - 1) : an.slideTo(an.slides.length - 1))
                        }
                        if (an.params.freeModeMomentum) {
                            if (R.length > 1) {
                                var O = R.pop()
                                  ...
                                  , G = O.time - I.time;
                                an.velocity = L / G,
                                an.velocity = an.velocity / 2,
                                Math.abs(an.velocity) < an.params.freeModeMinimumVelocity && (an.velocity = 0),
                                (G > 150 || (new window.Date).getTime() - O.time > 300) && (an.velocity = 0)
                            } else {
                                an.velocity = 0
                            }
                            an.velocity = an.velocity * an.params.freeModeMomentumVelocityRatio,
                            R.length = 0;
                            var M = 1000 * an.params.freeModeMomentumRatio
                              , A = an.velocity * M
                              , T = an.translate + A;
                            an.rtl && (T = -T);
                            var z, H = !1, D = 20 * Math.abs(an.velocity) * an.params.freeModeMomentumBounceRatio;
                            if (T < an.maxTranslate()) {
                                an.params.freeModeMomentumBounce ? (T + an.maxTranslate() < -D && (T = an.maxTranslate() - D),
                                z = an.maxTranslate(),
                                H = !0,
                                J = !0) : T = an.maxTranslate()
                            } else {
                                if (T > an.minTranslate()) {
                                    an.params.freeModeMomentumBounce ? (T - an.minTranslate() > D && (T = an.minTranslate() + D),
                                    z = an.minTranslate(),
                                    H = !0,
                                    J = !0) : T = an.minTranslate()
                                } else {
                                    if (an.params.freeModeSticky) {
                                        ...
                                        T = Math.abs(an.snapGrid[C] - T) < Math.abs(an.snapGrid[C - 1] - T) || "next" === an.swipeDirection ? an.snapGrid[C] : an.snapGrid[C - 1],
                                        an.rtl || (T = -T)
                                    }
                                }
                            }
                            if (0 !== an.velocity) {
                                M = an.rtl ? Math.abs((-T - an.translate) / an.velocity) : Math.abs((T - an.translate) / an.velocity)
                            } else {
                                if (an.params.freeModeSticky) {
                                    return void an.slideReset()
                                }
                            }
                            an.params.freeModeMomentumBounce && H ? (an.updateProgress(z),
                            an.setWrapperTransition(M),
                            an.setWrapperTranslate(T),
                            an.onTransitionStart(),
                            an.animating = !0,
                            an.wrapper.transitionEnd(function() {
                                an && J && (an.emit("onMomentumBounce", an),
                                an.setWrapperTransition(an.params.speed),
                                an.setWrapperTranslate(z),
                                an.wrapper.transitionEnd(function() {
                                    an && an.onTransitionEnd()
                                }))
                            })) : an.velocity ? (an.updateProgress(T),
                            an.setWrapperTransition(M),
                            an.setWrapperTranslate(T),
                            an.onTransitionStart(),
                            an.animating || (an.animating = !0,
                            an.wrapper.transitionEnd(function() {
                                an && an.onTransitionEnd()
                            }))) : an.updateProgress(T),
                            an.updateActiveIndex()
                        }
                        return void ((!an.params.freeModeMomentum || P >= an.params.longSwipesMs) && (an.updateProgress(),
                        an.updateActiveIndex()))
                    }
                    var X, Y = 0, ay = an.slidesSizesGrid[0];
                    for (X = 0; X < an.slidesGrid.length; X += an.params.slidesPerGroup) {
                        void 0 !== an.slidesGrid[X + an.params.slidesPerGroup] ? E >= an.slidesGrid[X] && E < an.slidesGrid[X + an.params.slidesPerGroup] && (Y = X,
                        ay = an.slidesGrid[X + an.params.slidesPerGroup] - an.slidesGrid[X]) : E >= an.slidesGrid[X] && (Y = X,
                        ay = an.slidesGrid[an.slidesGrid.length - 1] - an.slidesGrid[an.slidesGrid.length - 2])
                    }
                    ...
                    if (P > an.params.longSwipesMs) {
                        ...
                        "next" === an.swipeDirection && (ax >= an.params.longSwipesRatio ? an.slideTo(Y + an.params.slidesPerGroup) : an.slideTo(Y)),
                        "prev" === an.swipeDirection && (ax > 1 - an.params.longSwipesRatio ? an.slideTo(Y + an.params.slidesPerGroup) : an.slideTo(Y))
                    } else {
                        if (!an.params.shortSwipes) {
                            return void an.slideTo(an.activeIndex)
                        }
                        "next" === an.swipeDirection && an.slideTo(Y + an.params.slidesPerGroup),
                        "prev" === an.swipeDirection && an.slideTo(Y)
                    }
                }
            }
            ,
            ...
            an.slideTo = function(l, k, p, o) {
                ...
                void 0 === l && (l = 0),
                l < 0 && (l = 0),
                an.snapIndex = Math.floor(l / an.params.slidesPerGroup),
                an.snapIndex >= an.snapGrid.length && (an.snapIndex = an.snapGrid.length - 1);
                var m = -an.snapGrid[an.snapIndex];
                if (an.params.autoplay && an.autoplaying && (o || !an.params.autoplayDisableOnInteraction ? an.pauseAutoplay(k) : an.stopAutoplay()),
                an.updateProgress(m),
                an.params.normalizeSlideIndex) {
                    for (var n = 0; n < an.slidesGrid.length; n++) {
                        -Math.floor(100 * m) >= Math.floor(100 * an.slidesGrid[n]) && (l = n)
                    }
                }
                return !(!an.params.allowSwipeToNext && m < an.translate && m < an.minTranslate()) && (!(!an.params.allowSwipeToPrev && m > an.translate && m > an.maxTranslate() && (an.activeIndex || 0) !== l) && (void 0 === k && (k = an.params.speed),
                an.previousIndex = an.activeIndex || 0,
                an.activeIndex = l,
                an.updateRealIndex(),
                an.rtl && -m === an.translate || !an.rtl && m === an.translate ? (an.params.autoHeight && an.updateAutoHeight(),
                an.updateClasses(),
                "slide" !== an.params.effect && an.setWrapperTranslate(m),
                !1) : (an.updateClasses(),
                an.onTransitionStart(p),
                0 === k || an.browser.lteIE9 ? (an.setWrapperTranslate(m),
                an.setWrapperTransition(0),
                an.onTransitionEnd(p)) : (an.setWrapperTranslate(m),
                an.setWrapperTransition(k),
                an.animating || (an.animating = !0,
                an.wrapper.transitionEnd(function() {
            ...
            an.onTransitionStart = function(i) {
                void 0 === i && (i = !0),
                an.params.autoHeight && an.updateAutoHeight(),
                an.lazy && an.lazy.onTransitionStart(),
                i && (an.emit("onTransitionStart", an),
                an.activeIndex !== an.previousIndex && (an.emit("onSlideChangeStart", an),
                an.activeIndex > an.previousIndex ? an.emit("onSlideNextStart", an) : an.emit("onSlidePrevStart", an)))
            }
            ,
            an.onTransitionEnd = function(i) {
                ...
                an.setWrapperTransition(0),
                void 0 === i && (i = !0),
                an.lazy && an.lazy.onTransitionEnd(),
                i && (an.emit("onTransitionEnd", an),
                an.activeIndex !== an.previousIndex && (an.emit("onSlideChangeEnd", an),
                an.activeIndex > an.previousIndex ? an.emit("onSlideNextEnd", an) : an.emit("onSlidePrevEnd", an))),
                an.params.history && an.history && an.history.setHistory(an.params.history, an.activeIndex),
                an.params.hashnav && an.hashnav && an.hashnav.setHash()
            }
            ,
            ...
            an.disableTouchControl = function() {
                return an.params.onlyExternal = !0,
                !0
            }
            ,
            an.enableTouchControl = function() {
                return an.params.onlyExternal = !1,
                !0
            }
            ,
            an.setWrapperTransition = function(k, i) {
                an.wrapper.transition(k),
                "slide" !== an.params.effect && an.effects[an.params.effect] && an.effects[an.params.effect].setTransition(k),
                an.params.parallax && an.parallax && an.parallax.setTransition(k),
                an.params.scrollbar && an.scrollbar && an.scrollbar.setTransition(k),
                an.params.control && an.controller && an.controller.setTransition(k, i),
            ...
            an.setWrapperTranslate = function(l, k, v) {
                var u = 0
                  , m = 0;
                an.isHorizontal() ? u = an.rtl ? -l : l : m = l,
                an.params.roundLengths && (u = ak(u),
                m = ak(m)),
                an.params.virtualTranslate || (an.support.transforms3d ? an.wrapper.transform("translate3d(" + u + "px, " + m + "px, 0px)") : an.wrapper.transform("translate(" + u + "px, " + m + "px)")),
                an.translate = an.isHorizontal() ? u : m;
                var p, r = an.maxTranslate() - an.minTranslate();
                p = 0 === r ? 0 : (l - an.minTranslate()) / r,
                p !== an.progress && an.updateProgress(l),
                k && an.updateActiveIndex(),
                "slide" !== an.params.effect && an.effects[an.params.effect] && an.effects[an.params.effect].setTranslate(an.translate),
                an.params.parallax && an.parallax && an.parallax.setTranslate(an.translate),
                an.params.scrollbar && an.scrollbar && an.scrollbar.setTranslate(an.translate),
                an.params.control && an.controller && an.controller.setTranslate(an.translate, v),
                an.emit("onSetTranslate", an, an.translate)
            }
            ,
            an.getTranslate = function(l, k) {
                var p, o, m, n;
                return void 0 === k && (k = "x"),
                an.params.virtualTranslate ? an.rtl ? -an.translate : an.translate : (m = window.getComputedStyle(l, null),
                window.WebKitCSSMatrix ? (o = m.transform || m.webkitTransform,
                o.split(",").length > 6 && (o = o.split(", ").map(function(i) {
                    return i.replace(",", ".")
                }).join(", ")),
                n = new window.WebKitCSSMatrix("none" === o ? "" : o)) : (n = m.MozTransform || m.OTransform || m.MsTransform || m.msTransform || m.transform || m.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
                p = n.toString().split(",")),
                "x" === k && (o = window.WebKitCSSMatrix ? n.m41 : 16 === p.length ? parseFloat(p[12]) : parseFloat(p[4])),
                "y" === k && (o = window.WebKitCSSMatrix ? n.m42 : 16 === p.length ? parseFloat(p[13]) : parseFloat(p[5])),
                an.rtl && o && (o = -o),
                o || 0)
            }
            ,
            an.getWrapperTranslate = function(i) {
                return void 0 === i && (i = an.isHorizontal() ? "x" : "y"),
                an.getTranslate(an.wrapper[0], i)
            }
            ,
            an.observers = [],
            an.initObservers = function() {
            ...
            an.createLoop = function() {
                ...
                "auto" !== an.params.slidesPerView || an.params.loopedSlides || (an.params.loopedSlides = k.length),
                an.loopedSlides = parseInt(an.params.loopedSlides || an.params.slidesPerView, 10),
                an.loopedSlides = an.loopedSlides + an.params.loopAdditionalSlides,
                an.loopedSlides > k.length && (an.loopedSlides = k.length);
                var n, m = [], l = [];
                for (k.each(function(p, o) {
                    var i = c(this);
                    p < an.loopedSlides && l.push(o),
                    p < k.length && p >= k.length - an.loopedSlides && m.push(o),
                    i.attr("data-swiper-slide-index", p)
                }),
                n = 0; n < l.length; n++) {
            ...
            an.reLoop = function(k) {
                ...
                an.createLoop(),
                an.updateSlidesSize(),
                k && an.slideTo(i + an.loopedSlides, 0, !1)
            }
            ,
            an.fixLoop = function() {
                var i;
                ...
                i += an.loopedSlides,
                an.slideTo(i, 0, !1, !0)) : ("auto" === an.params.slidesPerView && an.activeIndex >= 2 * an.loopedSlides || an.activeIndex > an.slides.length - 2 * an.params.slidesPerView) && (i = -an.slides.length + an.activeIndex + an.loopedSlides,
                i += an.loopedSlides,
                an.slideTo(i, 0, !1, !0))
            }
            ,
            an.appendSlide = function(k) {
                if (an.params.loop && an.destroyLoop(),
                "object" == typeof k && k.length) {
                ...
                an.params.loop && an.createLoop(),
                an.params.observer && an.support.observer || an.update(!0)
            }
            ,
            ...
            an.removeSlide = function(k) {
                ...
                if ("object" == typeof k && k.length) {
                    for (var l = 0; l < k.length; l++) {
                        i = k[l],
                        an.slides[i] && an.slides.eq(i).remove(),
                        i < m && m--
                    }
                    m = Math.max(m, 0)
                } else {
            ...
            an.effects = {
                fade: {
                    setTranslate: function() {
                        for (var l = 0; l < an.slides.length; l++) {
                            ...
                            an.isHorizontal() || (m = o,
                            o = 0);
                            var n = an.params.fade.crossFade ? Math.max(1 - Math.abs(k[0].progress), 0) : 1 + Math.min(Math.max(k[0].progress, -1), 0);
                            k.css({
                                opacity: n
                    ...
                    setTransition: function(k) {
                        if (an.slides.transition(k),
                        an.params.virtualTranslate && 0 !== k) {
                            var i = !1;
                            an.slides.transitionEnd(function() {
                                if (!i && an) {
                                    i = !0,
                                    an.animating = !1;
                                    for (var l = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], m = 0; m < l.length; m++) {
                    ...
                    setTranslate: function() {
                        for (var k = 0; k < an.slides.length; k++) {
                            ...
                            var v = C[0].swiperSlideOffset
                              ...
                              , w = -v
                              , z = 0;
                            if (an.isHorizontal() ? an.rtl && (x = -x) : (z = w,
                            w = 0,
                            y = -x,
                            x = 0),
                            C[0].style.zIndex = -Math.abs(Math.round(B)) + an.slides.length,
                            an.params.flip.slideShadows) {
                                var m = an.isHorizontal() ? C.find(".swiper-slide-shadow-left") : C.find(".swiper-slide-shadow-top")
                                  , D = an.isHorizontal() ? C.find(".swiper-slide-shadow-right") : C.find(".swiper-slide-shadow-bottom");
                                0 === m.length && (m = c('<div class="swiper-slide-shadow-' + (an.isHorizontal() ? "left" : "top") + '"></div>'),
                                C.append(m)),
                                0 === D.length && (D = c('<div class="swiper-slide-shadow-' + (an.isHorizontal() ? "right" : "bottom") + '"></div>'),
                                C.append(D)),
                                m.length && (m[0].style.opacity = Math.max(-B, 0)),
                                D.length && (D[0].style.opacity = Math.max(B, 0))
                            }
                            C.transform("translate3d(" + w + "px, " + z + "px, 0px) rotateX(" + y + "deg) rotateY(" + x + "deg)")
                        }
                    },
                    setTransition: function(i) {
                        if (an.slides.transition(i).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(i),
                        an.params.virtualTranslate && 0 !== i) {
                            var k = !1;
                ...
                cube: {
                    setTranslate: function() {
                        var k, P = 0;
                        an.params.cube.shadow && (an.isHorizontal() ? (k = an.wrapper.find(".swiper-cube-shadow"),
                        0 === k.length && (k = c('<div class="swiper-cube-shadow"></div>'),
                        an.wrapper.append(k)),
                        k.css({
                            height: an.width + "px"
                        })) : (k = an.container.find(".swiper-cube-shadow"),
                        0 === k.length && (k = c('<div class="swiper-cube-shadow"></div>'),
                        an.container.append(k))));
                        for (var O = 0; O < an.slides.length; O++) {
                            ...
                            O % 4 == 0 ? (E = 4 * -H * an.size,
                            z = 0) : (O - 1) % 4 == 0 ? (E = 0,
                            z = 4 * -H * an.size) : (O - 2) % 4 == 0 ? (E = an.size + 4 * H * an.size,
                            z = an.size) : (O - 3) % 4 == 0 && (E = -an.size,
                            z = 3 * an.size + 4 * an.size * H),
                            an.rtl && (E = -E),
                            an.isHorizontal() || (L = E,
                            E = 0);
                            var S = "rotateX(" + (an.isHorizontal() ? 0 : -M) + "deg) rotateY(" + (an.isHorizontal() ? M : 0) + "deg) translate3d(" + E + "px, " + L + "px, " + z + "px)";
                            if (I <= 1 && I > -1 && (P = 90 * O + 90 * I,
                            an.rtl && (P = 90 * -O - 90 * I)),
                            D.transform(S),
                            an.params.cube.slideShadows) {
                                var x = an.isHorizontal() ? D.find(".swiper-slide-shadow-left") : D.find(".swiper-slide-shadow-top")
                                  , G = an.isHorizontal() ? D.find(".swiper-slide-shadow-right") : D.find(".swiper-slide-shadow-bottom");
                                0 === x.length && (x = c('<div class="swiper-slide-shadow-' + (an.isHorizontal() ? "left" : "top") + '"></div>'),
                                D.append(x)),
                                0 === G.length && (G = c('<div class="swiper-slide-shadow-' + (an.isHorizontal() ? "right" : "bottom") + '"></div>'),
                                D.append(G)),
                                x.length && (x[0].style.opacity = Math.max(-I, 0)),
                                G.length && (G[0].style.opacity = Math.max(I, 0))
                            }
                        }
                        if (an.wrapper.css({
                        ...
                        an.params.cube.shadow) {
                            if (an.isHorizontal()) {
                                k.transform("translate3d(0px, " + (an.width / 2 + an.params.cube.shadowOffset) + "px, " + -an.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + an.params.cube.shadowScale + ")")
                            } else {
                                var C = Math.abs(P) - 90 * Math.floor(Math.abs(P) / 90)
                                  , B = 1.5 - (Math.sin(2 * C * Math.PI / 360) / 2 + Math.cos(2 * C * Math.PI / 360) / 2)
                                  , A = an.params.cube.shadowScale
                                  , T = an.params.cube.shadowScale / B
                                  , X = an.params.cube.shadowOffset;
                                k.transform("scale3d(" + A + ", 1, " + T + ") translate3d(0px, " + (an.height / 2 + X) + "px, " + -an.height / 2 / T + "px) rotateX(-90deg)")
                            }
                        }
                        var Y = an.isSafari || an.isUiWebView ? -an.size / 2 : 0;
                        an.wrapper.transform("translate3d(0px,0," + Y + "px) rotateX(" + (an.isHorizontal() ? 0 : P) + "deg) rotateY(" + (an.isHorizontal() ? -P : 0) + "deg)")
                    },
                    setTransition: function(i) {
                        an.slides.transition(i).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(i),
                        an.params.cube.shadow && !an.isHorizontal() && an.container.find(".swiper-cube-shadow").transition(i)
                    }
                },
                coverflow: {
                    setTranslate: function() {
                        for (var k = an.translate, O = an.isHorizontal() ? -k + an.width / 2 : -k + an.height / 2, M = an.isHorizontal() ? an.params.coverflow.rotate : -an.params.coverflow.rotate, C = an.params.coverflow.depth, L = 0, G = an.slides.length; L < G; L++) {
                            ...
                            var z = "translate3d(" + A + "px," + B + "px," + E + "px)  rotateX(" + x + "deg) rotateY(" + P + "deg)";
                            if (H.transform(z),
                            H[0].style.zIndex = 1 - Math.abs(Math.round(y)),
                            an.params.coverflow.slideShadows) {
                                var S = an.isHorizontal() ? H.find(".swiper-slide-shadow-left") : H.find(".swiper-slide-shadow-top")
                                  , T = an.isHorizontal() ? H.find(".swiper-slide-shadow-right") : H.find(".swiper-slide-shadow-bottom");
                                0 === S.length && (S = c('<div class="swiper-slide-shadow-' + (an.isHorizontal() ? "left" : "top") + '"></div>'),
                                H.append(S)),
                                0 === T.length && (T = c('<div class="swiper-slide-shadow-' + (an.isHorizontal() ? "right" : "bottom") + '"></div>'),
                                H.append(T)),
            ...
            an.lazy = {
                ...
                loadImageInSlide: function(k, n) {
                    if (void 0 !== k && (void 0 === n && (n = !0),
                    0 !== an.slides.length)) {
                        var m = an.slides.eq(k)
                          , l = m.find("." + an.params.lazyLoadingClass + ":not(." + an.params.lazyStatusLoadedClass + "):not(." + an.params.lazyStatusLoadingClass + ")");
                        !m.hasClass(an.params.lazyLoadingClass) || m.hasClass(an.params.lazyStatusLoadedClass) || m.hasClass(an.params.lazyStatusLoadingClass) || (l = l.add(m[0])),
                        0 !== l.length && l.each(function() {
                            ...
                            an.loadImage(p[0], w || s, u, v, !1, function() {
                                if (void 0 !== an && null !== an && an) {
                                    ...
                                    p.removeAttr("data-background")) : (u && (p.attr("srcset", u),
                                    p.removeAttr("data-srcset")),
                                    v && (p.attr("sizes", v),
                                    p.removeAttr("data-sizes")),
                                    w && (p.attr("src", w),
                                    p.removeAttr("data-src"))),
                                    p.addClass(an.params.lazyStatusLoadedClass).removeClass(an.params.lazyStatusLoadingClass),
                                    m.find("." + an.params.lazyPreloaderClass + ", ." + an.params.preloaderClass).remove(),
                                    an.params.loop && n) {
                                        var i = m.attr("data-swiper-slide-index");
                                        if (m.hasClass(an.params.slideDuplicateClass)) {
                                            var o = an.wrapper.children('[data-swiper-slide-index="' + i + '"]:not(.' + an.params.slideDuplicateClass + ")");
                                            an.lazy.loadImageInSlide(o.index(), !1)
                                        } else {
                                            var r = an.wrapper.children("." + an.params.slideDuplicateClass + '[data-swiper-slide-index="' + i + '"]');
                ...
                load: function() {
                    ...
                    if ("auto" === y && (y = 0),
                    an.lazy.initialImageLoaded || (an.lazy.initialImageLoaded = !0),
                    an.params.watchSlidesVisibility) {
                    ...
                    if (an.params.lazyLoadingInPrevNext) {
                        if (y > 1 || an.params.lazyLoadingInPrevNextAmount && an.params.lazyLoadingInPrevNextAmount > 1) {
                ...
                onTransitionStart: function() {
                    an.params.lazyLoading && (an.params.lazyLoadingOnTransitionStart || !an.params.lazyLoadingOnTransitionStart && !an.lazy.initialImageLoaded) && an.lazy.load()
                },
            ...
            an.scrollbar = {
                ...
                setDragPosition: function(l) {
                    var k = an.scrollbar
                      , p = an.isHorizontal() ? "touchstart" === l.type || "touchmove" === l.type ? l.targetTouches[0].pageX : l.pageX || l.clientX : "touchstart" === l.type || "touchmove" === l.type ? l.targetTouches[0].pageY : l.pageY || l.clientY
                ...
                dragStart: function(k) {
                    ...
                    k.stopPropagation(),
                    i.setDragPosition(k),
                    clearTimeout(i.dragTimeout),
                    i.track.transition(0),
                    an.params.scrollbarHide && i.track.css("opacity", 1),
                    an.wrapper.transition(100),
                    i.drag.transition(100),
                    an.emit("onScrollbarDragStart", an)
                },
                dragMove: function(k) {
                    var i = an.scrollbar;
                    i.isTouched && (k.preventDefault ? k.preventDefault() : k.returnValue = !1,
                    i.setDragPosition(k),
                    an.wrapper.transition(0),
                    i.track.transition(0),
                    i.drag.transition(0),
                    an.emit("onScrollbarDragMove", an))
                },
                dragEnd: function(k) {
                    var i = an.scrollbar;
                    i.isTouched && (i.isTouched = !1,
                    an.params.scrollbarHide && (clearTimeout(i.dragTimeout),
                    i.dragTimeout = setTimeout(function() {
                        i.track.css("opacity", 0),
                        i.track.transition(400)
                    }, 1000)),
                    an.emit("onScrollbarDragEnd", an),
                    an.params.scrollbarSnapOnRelease && an.slideReset())
                },
                draggableEvents: function() {
                    return an.params.simulateTouch !== !1 || an.support.touch ? an.touchEvents : an.touchEventsDesktop
                }(),
                enableDraggable: function() {
                    var i = an.scrollbar
                      , k = an.support.touch ? i.track : document;
                    c(i.track).on(i.draggableEvents.start, i.dragStart),
                    c(k).on(i.draggableEvents.move, i.dragMove),
                    c(k).on(i.draggableEvents.end, i.dragEnd)
                },
                disableDraggable: function() {
                    var i = an.scrollbar
                      , k = an.support.touch ? i.track : document;
                    c(i.track).off(i.draggableEvents.start, i.dragStart),
                    c(k).off(i.draggableEvents.move, i.dragMove),
                    c(k).off(i.draggableEvents.end, i.dragEnd)
                },
                set: function() {
                    if (an.params.scrollbar) {
                        var i = an.scrollbar;
                        i.track = c(an.params.scrollbar),
                        an.params.uniqueNavElements && "string" == typeof an.params.scrollbar && i.track.length > 1 && 1 === an.container.find(an.params.scrollbar).length && (i.track = an.container.find(an.params.scrollbar)),
                        i.drag = i.track.find(".swiper-scrollbar-drag"),
                        0 === i.drag.length && (i.drag = c('<div class="swiper-scrollbar-drag"></div>'),
                        i.track.append(i.drag)),
                        i.drag[0].style.width = "",
                        i.drag[0].style.height = "",
                        i.trackSize = an.isHorizontal() ? i.track[0].offsetWidth : i.track[0].offsetHeight,
                        i.divider = an.size / an.virtualSize,
                        i.moveDivider = i.divider * (i.trackSize / an.size),
                        i.dragSize = i.trackSize * i.divider,
                        an.isHorizontal() ? i.drag[0].style.width = i.dragSize + "px" : i.drag[0].style.height = i.dragSize + "px",
                        i.divider >= 1 ? i.track[0].style.display = "none" : i.track[0].style.display = "",
                        an.params.scrollbarHide && (i.track[0].style.opacity = 0)
                    }
                },
                setTranslate: function() {
                    if (an.params.scrollbar) {
                        var k, i = an.scrollbar, l = (an.translate,
                        i.dragSize);
                        k = (i.trackSize - i.dragSize) * an.progress,
                        an.rtl && an.isHorizontal() ? (k = -k,
                        k > 0 ? (l = i.dragSize - k,
                        k = 0) : -k + i.dragSize > i.trackSize && (l = i.trackSize + k)) : k < 0 ? (l = i.dragSize + k,
                        k = 0) : k + i.dragSize > i.trackSize && (l = i.trackSize - k),
                        an.isHorizontal() ? (an.support.transforms3d ? i.drag.transform("translate3d(" + k + "px, 0, 0)") : i.drag.transform("translateX(" + k + "px)"),
                        i.drag[0].style.width = l + "px") : (an.support.transforms3d ? i.drag.transform("translate3d(0px, " + k + "px, 0)") : i.drag.transform("translateY(" + k + "px)"),
                        i.drag[0].style.height = l + "px"),
                        an.params.scrollbarHide && (clearTimeout(i.timeout),
                        i.track[0].style.opacity = 1,
                        i.timeout = setTimeout(function() {
                            i.track[0].style.opacity = 0,
                            i.track.transition(400)
                        }, 1000))
                    }
                },
            ...
            an.controller = {
                LinearSpline: function(l, k) {
                    ...
                    this.interpolate = function(i) {
                        return i ? (m = o(this.x, i),
                        n = m - 1,
                        (i - this.x[n]) * (this.y[m] - this.y[n]) / (this.x[m] - this.x[n]) + this.y[n]) : 0
                    }
                },
                getInterpolateFunction: function(i) {
                    an.controller.spline || (an.controller.spline = an.params.loop ? new an.controller.LinearSpline(an.slidesGrid,i.slidesGrid) : new an.controller.LinearSpline(an.snapGrid,i.snapGrid))
                },
                setTranslate: function(k, w) {
                    function v(i) {
                        ...
                        u = -an.controller.spline.interpolate(-k)),
                        u && "container" !== an.params.controlBy || (l = (i.maxTranslate() - i.minTranslate()) / (an.maxTranslate() - an.minTranslate()),
                        u = (k - an.minTranslate()) * l + i.minTranslate()),
                        an.params.controlInverse && (u = i.maxTranslate() - u),
                        i.updateProgress(u),
                        i.setWrapperTranslate(u, !1, an),
                        i.updateActiveIndex()
                    }
                ...
                setTransition: function(k, o) {
                    function n(i) {
                        i.setWrapperTransition(k, an),
                        0 !== k && (i.onTransitionStart(),
                        i.wrapper.transitionEnd(function() {
                            m && (i.params.loop && "slide" === an.params.controlBy && i.fixLoop(),
                            i.onTransitionEnd())
                        }))
                    }
            ...
            an.hashnav = {
                onHashCange: function(k, i) {
                    ...
                    l !== an.slides.eq(an.activeIndex).attr("data-hash") && an.slideTo(an.wrapper.children("." + an.params.slideClass + '[data-hash="' + l + '"]').index())
                },
                ...
                setHash: function() {
                    if (an.hashnav.initialized && an.params.hashnav) {
                        if (an.params.replaceState && window.history && window.history.replaceState) {
                            window.history.replaceState(null, null, "#" + an.slides.eq(an.activeIndex).attr("data-hash") || "")
                        } else {
            ...
            an.history = {
                init: function() {
                    if (an.params.history) {
                        if (!window.history || !window.history.pushState) {
                            return an.params.history = !1,
                            void (an.params.hashnav = !0)
                        }
                        an.history.initialized = !0,
                        this.paths = this.getPathValues(),
                        (this.paths.key || this.paths.value) && (this.scrollToSlide(0, this.paths.value, an.params.runCallbacksOnInit),
                        an.params.replaceState || window.addEventListener("popstate", this.setHistoryPopState))
                    }
                },
                setHistoryPopState: function() {
                    an.history.paths = an.history.getPathValues(),
                    an.history.scrollToSlide(an.params.speed, an.history.paths.value, !1)
                },
                ...
                setHistory: function(k, i) {
                    if (an.history.initialized && an.params.history) {
                        ...
                        window.location.pathname.includes(k) || (l = k + "/" + l),
                        an.params.replaceState ? window.history.replaceState(null, null, l) : window.history.pushState(null, null, l)
                    }
                },
                slugify: function(i) {
            ...
            an.disableKeyboardControl = function() {
                an.params.keyboardControl = !1,
                c(document).off("keydown", ai)
            }
            ,
            an.enableKeyboardControl = function() {
                an.params.keyboardControl = !0,
                c(document).on("keydown", ai)
            }
            ,
            an.mousewheel = {
                event: !1,
            ...
            an.params.mousewheelControl && (an.mousewheel.event = navigator.userAgent.indexOf("firefox") > -1 ? "DOMMouseScroll" : function() {
                var k = "onwheel"in document;
                if (!k) {
                    var i = document.createElement("div");
                    i.setAttribute("onwheel", "return;"),
                    k = "function" == typeof i.onwheel
                }
                return !k && document.implementation && document.implementation.hasFeature && document.implementation.hasFeature("", "") !== !0 && (k = document.implementation.hasFeature("Events.wheel", "3.0")),
                k
            }() ? "wheel" : "mousewheel"),
            an.disableMousewheelControl = function() {
                if (!an.mousewheel.event) {
                    return !1
                }
                var i = an.container;
                return "container" !== an.params.mousewheelEventsTarged && (i = c(an.params.mousewheelEventsTarged)),
                i.off(an.mousewheel.event, ao),
                an.params.mousewheelControl = !1,
                !0
            }
            ,
            an.enableMousewheelControl = function() {
                ...
                var i = an.container;
                return "container" !== an.params.mousewheelEventsTarged && (i = c(an.params.mousewheelEventsTarged)),
                i.on(an.mousewheel.event, ao),
                an.params.mousewheelControl = !0,
                !0
            }
            ,
            an.parallax = {
                setTranslate: function() {
                    an.container.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function() {
                        q(this, an.progress)
                    }),
                ...
                setTransition: function(i) {
                    void 0 === i && (i = an.params.speed),
                    an.container.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function() {
                        var l = c(this)
            ...
            an.zoom = {
                ...
                onGestureStart: function(i) {
                    ...
                    if (!an.support.gestures) {
                        if ("touchstart" !== i.type || "touchstart" === i.type && i.targetTouches.length < 2) {
                            return
                        }
                        k.gesture.scaleStart = k.getDistanceBetweenTouches(i)
                    }
                    if (!(k.gesture.slide && k.gesture.slide.length || (k.gesture.slide = c(this),
                    0 === k.gesture.slide.length && (k.gesture.slide = an.slides.eq(an.activeIndex)),
                    k.gesture.image = k.gesture.slide.find("img, svg, canvas"),
                    k.gesture.imageWrap = k.gesture.image.parent("." + an.params.zoomContainerClass),
                    k.gesture.zoomMax = k.gesture.imageWrap.attr("data-swiper-zoom") || an.params.zoomMax,
                    0 !== k.gesture.imageWrap.length))) {
                        return void (k.gesture.image = void 0)
                    }
                    k.gesture.image.transition(0),
                    k.isScaling = !0
                },
                onGestureChange: function(k) {
                    ...
                    i.gesture.image && 0 !== i.gesture.image.length && (an.support.gestures ? i.scale = k.scale * i.currentScale : i.scale = i.gesture.scaleMove / i.gesture.scaleStart * i.currentScale,
                    i.scale > i.gesture.zoomMax && (i.scale = i.gesture.zoomMax - 1 + Math.pow(i.scale - i.gesture.zoomMax + 1, 0.5)),
                    i.scale < an.params.zoomMin && (i.scale = an.params.zoomMin + 1 - Math.pow(an.params.zoomMin - i.scale + 1, 0.5)),
                    i.gesture.image.transform("translate3d(0,0,0) scale(" + i.scale + ")"))
                },
                onGestureEnd: function(k) {
                    var i = an.zoom;
                    !an.support.gestures && ("touchend" !== k.type || "touchend" === k.type && k.changedTouches.length < 2) || i.gesture.image && 0 !== i.gesture.image.length && (i.scale = Math.max(Math.min(i.scale, i.gesture.zoomMax), an.params.zoomMin),
                    i.gesture.image.transition(an.params.speed).transform("translate3d(0,0,0) scale(" + i.scale + ")"),
                    i.currentScale = i.scale,
                    i.isScaling = !1,
                    1 === i.scale && (i.gesture.slide = void 0))
                },
                onTouchStart: function(k, i) {
                    var l = k.zoom;
                    l.gesture.image && 0 !== l.gesture.image.length && (l.image.isTouched || ("android" === k.device.os && i.preventDefault(),
                    l.image.isTouched = !0,
                    l.image.touchesStart.x = "touchstart" === i.type ? i.targetTouches[0].pageX : i.pageX,
                    l.image.touchesStart.y = "touchstart" === i.type ? i.targetTouches[0].pageY : i.pageY))
                },
                onTouchMove: function(k) {
                    var i = an.zoom;
                    if (i.gesture.image && 0 !== i.gesture.image.length && (an.allowClick = !1,
                    i.image.isTouched && i.gesture.slide)) {
                        i.image.isMoved || (i.image.width = i.gesture.image[0].offsetWidth,
                        i.image.height = i.gesture.image[0].offsetHeight,
                        i.image.startX = an.getTranslate(i.gesture.imageWrap[0], "x") || 0,
                        i.image.startY = an.getTranslate(i.gesture.imageWrap[0], "y") || 0,
                        i.gesture.slideWidth = i.gesture.slide[0].offsetWidth,
                        i.gesture.slideHeight = i.gesture.slide[0].offsetHeight,
                        i.gesture.imageWrap.transition(0),
                        an.rtl && (i.image.startX = -i.image.startX),
                        an.rtl && (i.image.startY = -i.image.startY));
                        var m = i.image.width * i.scale
                          , l = i.image.height * i.scale;
                        if (!(m < i.gesture.slideWidth && l < i.gesture.slideHeight)) {
                            if (i.image.minX = Math.min(i.gesture.slideWidth / 2 - m / 2, 0),
                            i.image.maxX = -i.image.minX,
                            i.image.minY = Math.min(i.gesture.slideHeight / 2 - l / 2, 0),
                            i.image.maxY = -i.image.minY,
                            i.image.touchesCurrent.x = "touchmove" === k.type ? k.targetTouches[0].pageX : k.pageX,
                            i.image.touchesCurrent.y = "touchmove" === k.type ? k.targetTouches[0].pageY : k.pageY,
                            !i.image.isMoved && !i.isScaling) {
                                if (an.isHorizontal() && Math.floor(i.image.minX) === Math.floor(i.image.startX) && i.image.touchesCurrent.x < i.image.touchesStart.x || Math.floor(i.image.maxX) === Math.floor(i.image.startX) && i.image.touchesCurrent.x > i.image.touchesStart.x) {
                                    return void (i.image.isTouched = !1)
                                }
                                if (!an.isHorizontal() && Math.floor(i.image.minY) === Math.floor(i.image.startY) && i.image.touchesCurrent.y < i.image.touchesStart.y || Math.floor(i.image.maxY) === Math.floor(i.image.startY) && i.image.touchesCurrent.y > i.image.touchesStart.y) {
                                    return void (i.image.isTouched = !1)
                                }
                            }
                            k.preventDefault(),
                            k.stopPropagation(),
                            i.image.isMoved = !0,
                            i.image.currentX = i.image.touchesCurrent.x - i.image.touchesStart.x + i.image.startX,
                            i.image.currentY = i.image.touchesCurrent.y - i.image.touchesStart.y + i.image.startY,
                            i.image.currentX < i.image.minX && (i.image.currentX = i.image.minX + 1 - Math.pow(i.image.minX - i.image.currentX + 1, 0.8)),
                            i.image.currentX > i.image.maxX && (i.image.currentX = i.image.maxX - 1 + Math.pow(i.image.currentX - i.image.maxX + 1, 0.8)),
                            i.image.currentY < i.image.minY && (i.image.currentY = i.image.minY + 1 - Math.pow(i.image.minY - i.image.currentY + 1, 0.8)),
                            i.image.currentY > i.image.maxY && (i.image.currentY = i.image.maxY - 1 + Math.pow(i.image.currentY - i.image.maxY + 1, 0.8)),
                            i.velocity.prevPositionX || (i.velocity.prevPositionX = i.image.touchesCurrent.x),
                            i.velocity.prevPositionY || (i.velocity.prevPositionY = i.image.touchesCurrent.y),
                            i.velocity.prevTime || (i.velocity.prevTime = Date.now()),
                            i.velocity.x = (i.image.touchesCurrent.x - i.velocity.prevPositionX) / (Date.now() - i.velocity.prevTime) / 2,
                            i.velocity.y = (i.image.touchesCurrent.y - i.velocity.prevPositionY) / (Date.now() - i.velocity.prevTime) / 2,
                            Math.abs(i.image.touchesCurrent.x - i.velocity.prevPositionX) < 2 && (i.velocity.x = 0),
                            Math.abs(i.image.touchesCurrent.y - i.velocity.prevPositionY) < 2 && (i.velocity.y = 0),
                            i.velocity.prevPositionX = i.image.touchesCurrent.x,
                            i.velocity.prevPositionY = i.image.touchesCurrent.y,
                            i.velocity.prevTime = Date.now(),
                            i.gesture.imageWrap.transform("translate3d(" + i.image.currentX + "px, " + i.image.currentY + "px,0)")
                        }
                    }
                },
                onTouchEnd: function(v, k) {
                    ...
                    if (D.gesture.image && 0 !== D.gesture.image.length) {
                        if (!D.image.isTouched || !D.image.isMoved) {
                            return D.image.isTouched = !1,
                            void (D.image.isMoved = !1)
                        }
                        D.image.isTouched = !1,
                        D.image.isMoved = !1;
                        var C = 300
                        ...
                        0 !== D.velocity.x && (C = Math.abs((y - D.image.currentX) / D.velocity.x)),
                        0 !== D.velocity.y && (w = Math.abs((x - D.image.currentY) / D.velocity.y));
                        var A = Math.max(C, w);
                        D.image.currentX = y,
                        D.image.currentY = x;
                        var m = D.image.width * D.scale
                          , E = D.image.height * D.scale;
                        D.image.minX = Math.min(D.gesture.slideWidth / 2 - m / 2, 0),
                        D.image.maxX = -D.image.minX,
                        D.image.minY = Math.min(D.gesture.slideHeight / 2 - E / 2, 0),
                        D.image.maxY = -D.image.minY,
                        D.image.currentX = Math.max(Math.min(D.image.currentX, D.image.maxX), D.image.minX),
                        D.image.currentY = Math.max(Math.min(D.image.currentY, D.image.maxY), D.image.minY),
                        D.gesture.imageWrap.transition(A).transform("translate3d(" + D.image.currentX + "px, " + D.image.currentY + "px,0)")
                    }
                },
                onTransitionEnd: function(k) {
                    var i = k.zoom;
                    i.gesture.slide && k.previousIndex !== k.activeIndex && (i.gesture.image.transform("translate3d(0,0,0) scale(1)"),
                    i.gesture.imageWrap.transform("translate3d(0,0,0)"),
                    i.gesture.slide = i.gesture.image = i.gesture.imageWrap = void 0,
                    i.scale = i.currentScale = 1)
                },
                toggleZoom: function(k, S) {
                    var P = k.zoom;
                    if (P.gesture.slide || (P.gesture.slide = k.clickedSlide ? c(k.clickedSlide) : k.slides.eq(k.activeIndex),
                    P.gesture.image = P.gesture.slide.find("img, svg, canvas"),
                    ...
                    P.gesture.image && 0 !== P.gesture.image.length) {
                        ...
                        void 0 === P.image.touchesStart.x && S ? (E = "touchend" === S.type ? S.changedTouches[0].pageX : S.pageX,
                        O = "touchend" === S.type ? S.changedTouches[0].pageY : S.pageY) : (E = P.image.touchesStart.x,
                        O = P.image.touchesStart.y),
                        P.scale && 1 !== P.scale ? (P.scale = P.currentScale = 1,
                        P.gesture.imageWrap.transition(300).transform("translate3d(0,0,0)"),
                        P.gesture.image.transition(300).transform("translate3d(0,0,0) scale(1)"),
                        P.gesture.slide = void 0) : (P.scale = P.currentScale = P.gesture.imageWrap.attr("data-swiper-zoom") || k.params.zoomMax,
                        S ? (az = P.gesture.slide[0].offsetWidth,
                        X = P.gesture.slide[0].offsetHeight,
                        I = P.gesture.slide.offset().left,
                        L = P.gesture.slide.offset().top,
                        G = I + az / 2 - E,
                        M = L + X / 2 - O,
                        z = P.gesture.image[0].offsetWidth,
                        H = P.gesture.image[0].offsetHeight,
                        D = z * P.scale,
                        C = H * P.scale,
                        B = Math.min(az / 2 - D / 2, 0),
                        ax = Math.min(X / 2 - C / 2, 0),
                        ay = -B,
                        aA = -ax,
                        A = G * P.scale,
                        Y = M * P.scale,
                        ...
                        Y > aA && (Y = aA)) : (A = 0,
                        Y = 0),
                        P.gesture.imageWrap.transition(300).transform("translate3d(" + A + "px, " + Y + "px,0)"),
                        P.gesture.image.transition(300).transform("translate3d(0,0,0) scale(" + P.scale + ")"))
                    }
                },
                attachEvents: function(i) {
                    var l = i ? "off" : "on";
                    if (an.params.zoom) {
                        var k = (an.slides,
                        !("touchstart" !== an.touchEvents.start || !an.support.passiveListener || !an.params.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        });
                        an.support.gestures ? (an.slides[l]("gesturestart", an.zoom.onGestureStart, k),
                        an.slides[l]("gesturechange", an.zoom.onGestureChange, k),
                        an.slides[l]("gestureend", an.zoom.onGestureEnd, k)) : "touchstart" === an.touchEvents.start && (an.slides[l](an.touchEvents.start, an.zoom.onGestureStart, k),
                        an.slides[l](an.touchEvents.move, an.zoom.onGestureChange, k),
                        an.slides[l](an.touchEvents.end, an.zoom.onGestureEnd, k)),
                        an[l]("touchStart", an.zoom.onTouchStart),
                        an.slides.each(function(m, n) {
                            c(n).find("." + an.params.zoomContainerClass).length > 0 && c(n)[l](an.touchEvents.move, an.zoom.onTouchMove)
                        }),
                        an[l]("touchEnd", an.zoom.onTouchEnd),
                        an[l]("transitionEnd", an.zoom.onTransitionEnd),
                        an.params.zoomToggle && an.on("doubleTap", an.zoom.toggleZoom)
                    }
                },
                init: function() {
            ...
            return an.callPlugins = function(k) {
                for (var i = 0; i < an._plugins.length; i++) {
                    k in an._plugins[i] && an._plugins[i][k](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
                }
            }
            ,
            an.emitterEventListeners = {},
            an.emit = function(k) {
                an.params[k] && an.params[k](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
                var i;
                if (an.emitterEventListeners[k]) {
                    for (i = 0; i < an.emitterEventListeners[k].length; i++) {
                        an.emitterEventListeners[k][i](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
                    }
                }
                an.callPlugins && an.callPlugins(k, arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
            }
            ,
            an.on = function(k, i) {
                return k = ad(k),
                an.emitterEventListeners[k] || (an.emitterEventListeners[k] = []),
                an.emitterEventListeners[k].push(i),
                an
            }
            ,
            an.off = function(k, i) {
                ...
                if (k = ad(k),
                void 0 === i) {
                    return an.emitterEventListeners[k] = [],
                    an
                }
            ...
            an.once = function(k, i) {
                k = ad(k);
                var l = function() {
                    i(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4]),
                    an.off(k, l)
                };
                return an.on(k, l),
                an
            ...
            an.a11y = {
                makeFocusable: function(i) {
                    return i.attr("tabIndex", "0"),
                    i
                },
                addRole: function(k, i) {
                    return k.attr("role", i),
                    k
                },
                addLabel: function(k, i) {
                    return k.attr("aria-label", i),
                    k
                },
                disable: function(i) {
                    return i.attr("aria-disabled", !0),
                    i
                },
                enable: function(i) {
                    return i.attr("aria-disabled", !1),
                    i
                },
                onEnterKey: function(i) {
                    13 === i.keyCode && (c(i.target).is(an.params.nextButton) ? (an.onClickNext(i),
                    an.isEnd ? an.a11y.notify(an.params.lastSlideMessage) : an.a11y.notify(an.params.nextSlideMessage)) : c(i.target).is(an.params.prevButton) && (an.onClickPrev(i),
                    an.isBeginning ? an.a11y.notify(an.params.firstSlideMessage) : an.a11y.notify(an.params.prevSlideMessage)),
                    c(i.target).is("." + an.params.bulletClass) && c(i.target)[0].click())
                },
                liveRegion: c('<span class="' + an.params.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>'),
                notify: function(k) {
                ...
                init: function() {
                    an.params.nextButton && an.nextButton && an.nextButton.length > 0 && (an.a11y.makeFocusable(an.nextButton),
                    an.a11y.addRole(an.nextButton, "button"),
                    an.a11y.addLabel(an.nextButton, an.params.nextSlideMessage)),
                    an.params.prevButton && an.prevButton && an.prevButton.length > 0 && (an.a11y.makeFocusable(an.prevButton),
                    an.a11y.addRole(an.prevButton, "button"),
                    an.a11y.addLabel(an.prevButton, an.params.prevSlideMessage)),
                    c(an.container).append(an.a11y.liveRegion)
                },
                initPagination: function() {
                    an.params.pagination && an.params.paginationClickable && an.bullets && an.bullets.length && an.bullets.each(function() {
                        var i = c(this);
                        an.a11y.makeFocusable(i),
                        an.a11y.addRole(i, "button"),
                        an.a11y.addLabel(i, an.params.paginationBulletMessage.replace(/{{index}}/, i.index() + 1))
                    })
                },
                destroy: function() {
            ...
            an.init = function() {
                ...
                an.updatePagination(),
                an.params.scrollbar && an.scrollbar && (an.scrollbar.set(),
                an.params.scrollbarDraggable && an.scrollbar.enableDraggable()),
                "slide" !== an.params.effect && an.effects[an.params.effect] && (an.params.loop || an.updateProgress(),
                an.effects[an.params.effect].setTranslate()),
                an.params.loop ? an.slideTo(an.params.initialSlide + an.loopedSlides, 0, an.params.runCallbacksOnInit) : (an.slideTo(an.params.initialSlide, 0, an.params.runCallbacksOnInit),
                0 === an.params.initialSlide && (an.parallax && an.params.parallax && an.parallax.setTranslate(),
                an.lazy && an.params.lazyLoading && (an.lazy.load(),
                an.lazy.initialImageLoaded = !0))),
                an.attachEvents(),
                an.params.observer && an.support.observer && an.initObservers(),
                an.params.preloadImages && !an.params.lazyLoading && an.preloadImages(),
                an.params.zoom && an.zoom && an.zoom.init(),
                an.params.autoplay && an.startAutoplay(),
                an.params.keyboardControl && an.enableKeyboardControl && an.enableKeyboardControl(),
                an.params.mousewheelControl && an.enableMousewheelControl && an.enableMousewheelControl(),
                an.params.hashnavReplaceState && (an.params.replaceState = an.params.hashnavReplaceState),
                an.params.history && an.history && an.history.init(),
                an.params.hashnav && an.hashnav && an.hashnav.init(),
                an.params.a11y && an.a11y && an.a11y.init(),
                an.emit("onInit", an)
            }
            ,
            an.cleanupStyles = function() {
                an.container.removeClass(an.classNames.join(" ")).removeAttr("style"),
                an.wrapper.removeAttr("style"),
                an.slides && an.slides.length && an.slides.removeClass([an.params.slideVisibleClass, an.params.slideActiveClass, an.params.slideNextClass, an.params.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-column").removeAttr("data-swiper-row"),
                an.paginationContainer && an.paginationContainer.length && an.paginationContainer.removeClass(an.params.paginationHiddenClass),
                an.bullets && an.bullets.length && an.bullets.removeClass(an.params.bulletActiveClass),
                an.params.prevButton && c(an.params.prevButton).removeClass(an.params.buttonDisabledClass),
                an.params.nextButton && c(an.params.nextButton).removeClass(an.params.buttonDisabledClass),
                an.params.scrollbar && an.scrollbar && (an.scrollbar.track && an.scrollbar.track.length && an.scrollbar.track.removeAttr("style"),
                an.scrollbar.drag && an.scrollbar.drag.length && an.scrollbar.drag.removeAttr("style"))
            }
            ,
            an.destroy = function(k, i) {
                an.detachEvents(),
                an.stopAutoplay(),
                an.params.scrollbar && an.scrollbar && an.params.scrollbarDraggable && an.scrollbar.disableDraggable(),
                an.params.loop && an.destroyLoop(),
                i && an.cleanupStyles(),
                an.disconnectObservers(),
                an.params.zoom && an.zoom && an.zoom.destroy(),
                an.params.keyboardControl && an.disableKeyboardControl && an.disableKeyboardControl(),
                an.params.mousewheelControl && an.disableMousewheelControl && an.disableMousewheelControl(),
                an.params.a11y && an.a11y && an.a11y.destroy(),
                an.params.history && !an.params.replaceState && window.removeEventListener("popstate", an.history.setHistoryPopState),
                an.params.hashnav && an.hashnav && an.hashnav.destroy(),
                an.emit("onDestroy"),
                k !== !1 && (an = null)
            }
            ,
    ...
    b.prototype = {
        ...
        browser: {
            ...
            lteIE9: function() {
                ...
                return a.innerHTML = "<!--[if lte IE 9]><i></i><![endif]-->",
        ...
        support: {
            ...
            flexbox: function() {
                for (var j = document.createElement("div").style, i = "alignItems webkitAlignItems webkitBoxAlign msFlexAlign mozBoxAlign webkitFlexDirection msFlexDirection mozBoxDirection mozBoxOrient webkitBoxDirection webkitBoxOrient".split(" "), k = 0; k < i.length; k++) {
                    if (i[k]in j) {
                        return !0
                    }
                }
    ...
    for (var h = (function() {
            ...
            if (e) {
                if ("string" == typeof e) {
                    ...
                    if (q.indexOf("<") >= 0 && q.indexOf(">") >= 0) {
                        var m = "div";
                        for (0 === q.indexOf("<li") && (m = "ul"),
                        0 === q.indexOf("<tr") && (m = "tbody"),
                        0 !== q.indexOf("<td") && 0 !== q.indexOf("<th") || (m = "tr"),
                        0 === q.indexOf("<tbody") && (m = "table"),
                        0 === q.indexOf("<option") && (m = "select"),
                        p = document.createElement(m),
                        p.innerHTML = e,
                        k = 0; k < p.childNodes.length; k++) {
                            v.push(p.childNodes[k])
                        }
                    } else {
                        for (u = w || "#" !== e[0] || e.match(/[ .<>:~]/) ? (w || document).querySelectorAll(e) : [document.getElementById(e.split("#")[1])],
                        k = 0; k < u.length; k++) {
                            u[k] && v.push(u[k])
                        }
                    }
        ...
        return j.prototype = {
            ...
            data: function(l, k) {
                if (void 0 !== k) {
                    for (var o = 0; o < this.length; o++) {
                        ...
                        n.dom7ElementDataStorage[l] = k
                    }
                    return this
                }
                if (this[0]) {
                    var m = this[0].getAttribute("data-" + l);
                    return m ? m : this[0].dom7ElementDataStorage && l in this[0].dom7ElementDataStorage ? this[0].dom7ElementDataStorage[l] : void 0
                }
            },
            transform: function(l) {
                for (var k = 0; k < this.length; k++) {
                    var m = this[k].style;
                    m.webkitTransform = m.MsTransform = m.msTransform = m.MozTransform = m.OTransform = m.transform = l
                }
                return this
            },
            transition: function(l) {
                ...
                for (var k = 0; k < this.length; k++) {
                    var m = this[k].style;
                    m.webkitTransitionDuration = m.MsTransitionDuration = m.msTransitionDuration = m.MozTransitionDuration = m.OTransitionDuration = m.transitionDuration = l
                }
                return this
            },
            on: function(a, w, v, k) {
                ...
                for (p = 0; p < this.length; p++) {
                    if ("function" == typeof w || w === !1) {
                        for ("function" == typeof w && (v = arguments[1],
                        k = arguments[2] || !1),
                        q = 0; q < m.length; q++) {
                        ...
                        for (q = 0; q < m.length; q++) {
                            this[p].dom7LiveListeners || (this[p].dom7LiveListeners = []),
                            this[p].dom7LiveListeners.push({
                                listener: v,
                                liveListener: u
                            }),
                ...
                for (var m = l.split(" "), u = 0; u < m.length; u++) {
                    for (var p = 0; p < this.length; p++) {
                        if ("function" == typeof k || k === !1) {
                            "function" == typeof k && (w = arguments[1],
                            v = arguments[2] || !1),
                            this[p].removeEventListener(m[u], w, v)
                        } else {
                            if (this[p].dom7LiveListeners) {
                                for (var q = 0; q < this[p].dom7LiveListeners.length; q++) {
                                    this[p].dom7LiveListeners[q].listener === w && this[p].removeEventListener(m[u], this[p].dom7LiveListeners[q].liveListener, v)
                                }
                            }
                        }
                    }
            ...
            transitionEnd: function(l) {
                ...
                var o, n = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], m = this;
                if (l) {
            ...
            eq: function(e) {
                ...
                var l, k = this.length;
                return e > k - 1 ? new j([]) : e < 0 ? (l = k + e,
                new j(l < 0 ? [] : [this[l]])) : new j([this[e]])
            },
            append: function(e) {
                var m, l;
            ...
            insertAfter: function(a) {
                for (var m = i(a), l = 0; l < this.length; l++) {
                    if (1 === m.length) {
                        ...
                        if (m.length > 1) {
                            for (var k = 0; k < m.length; k++) {
                                m[k].parentNode.insertBefore(this[l].cloneNode(!0), m[k].nextSibling)
                            }
                        }
                    }
                }
            ...
            next: function(a) {
                return new j(this.length > 0 ? a ? this[0].nextElementSibling && i(this[0].nextElementSibling).is(a) ? [this[0].nextElementSibling] : [] : this[0].nextElementSibling ? [this[0].nextElementSibling] : [] : [])
            },
            nextAll: function(l) {
                var k = []
                  , a = this[0];
                ...
                for (; a.nextElementSibling; ) {
                    ...
                    l ? i(e).is(l) && k.push(e) : k.push(e),
                    a = e
                }
                return new j(k)
            },
            prev: function(a) {
                return new j(this.length > 0 ? a ? this[0].previousElementSibling && i(this[0].previousElementSibling).is(a) ? [this[0].previousElementSibling] : [] : this[0].previousElementSibling ? [this[0].previousElementSibling] : [] : [])
            },
            prevAll: function(l) {
                var k = []
                  , a = this[0];
            ...
            parent: function(a) {
                for (var l = [], k = 0; k < this.length; k++) {
                    a ? i(this[k].parentNode).is(a) && l.push(this[k].parentNode) : l.push(this[k].parentNode)
                }
                return i(i.unique(l))
            },
            parents: function(a) {
            ...
            children: function(m) {
                for (var l = [], a = 0; a < this.length; a++) {
                    for (var k = this[a].childNodes, e = 0; e < k.length; e++) {
                        m ? 1 === k[e].nodeType && i(k[e]).is(m) && l.push(k[e]) : 1 === k[e].nodeType && l.push(k[e])
                    }
                }
    ...
    var f;
    f = void 0 === h ? window.Dom7 || window.Zepto || window.jQuery : h,
    f && ("transitionEnd"in f.fn || (f.fn.transitionEnd = function(k) {
        function j(a) {
            if (a.target === this) {
                for (k.call(this, a),
                n = 0; n < m.length; n++) {
        ...
        var n, m = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], l = this;
        if (k) {
...
!function(b, e, a, c, d) {
    b.fn.multiscroll = function(O) {
        ...
        var U = 600
          , ab = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/)
          , V = "ontouchstart"in e || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints;
        ".ms-right" !== O.rightSelector && b(O.rightSelector).addClass("ms-right"),
        ".ms-left" !== O.leftSelector && b(O.leftSelector).addClass("ms-left");
        var ag, j, X, ak = b(".ms-left").find(".ms-section").length, ad = !1, af = b(e).height(), K = function() {
            var f;
            f = e.PointerEvent ? {
                down: "pointerdown",
                move: "pointermove"
        ...
        function I() {
            ...
            b('<div class="multiscroll-tooltip ' + O.navigationPosition + '">' + f + "</div>").hide().appendTo(b(this)).fadeIn(200)
        }
        function al() {
        ...
        O.css3 && (O.css3 = function() {
            ...
            for (var h in a.body.insertBefore(i, null),
            g) {
                i.style[h] !== d && (i.style[h] = "translate3d(1px,1px,1px)",
                f = e.getComputedStyle(i).getPropertyValue(g[h]))
            }
            return a.body.removeChild(i),
            f !== d && 0 < f.length && "none" !== f
        }()),
        b("html, body").css({
            overflow: "hidden",
            height: "100%"
        ...
        O.navigation && (b("body").append('<div id="multiscroll-nav"><ul></ul></div>'),
        (ag = b("#multiscroll-nav")).css("color", O.navigationColor),
        ag.addClass(O.navigationPosition)),
        ...
        b(".ms-left .ms-section, .ms-right .ms-section").each(function() {
            ...
            if ((O.paddingTop || O.paddingBottom) && b(this).css("padding", O.paddingTop + " 0 " + O.paddingBottom + " 0"),
            void 0 !== O.sectionsColor[i] && b(this).css("background-color", O.sectionsColor[i]),
            void 0 !== O.anchors[i] && b(this).attr("data-anchor", O.anchors[i]),
            O.verticalCentered && (f = b(this)).addClass("ms-table").wrapInner('<div class="ms-tableCell" style="height: ' + Y(f) + 'px" />'),
            b(this).closest(".ms-left").length && O.navigation) {
                var g = "";
                O.anchors.length && (g = O.anchors[i]);
                var h = O.navigationTooltips[i];
                void 0 === h && (h = ""),
                O.navigation && ag.find("ul").append('<li data-tooltip="' + h + '"><a href="#' + g + '"><span></span></a></li>')
            }
        }),
        ...
        b(".ms-left .ms-section, .ms-right .ms-section").each(function() {
            ...
            b(".ms-left .ms-section.active").length || (b(".ms-right").find(".ms-section").last().addClass("active"),
            b(".ms-left").find(".ms-section").first().addClass("active")),
            O.navigation && ag.css("margin-top", "-" + ag.height() / 2 + "px"),
            b.isFunction(O.afterRender) && O.afterRender.call(this),
            q(),
            N(),
            b(e).on("load", function() {
                var f, g;
                f = e.location.hash.replace("#", ""),
                g = b('.ms-left .ms-section[data-anchor="' + f + '"]'),
                f.length && ao(g)
            })
        }),
        b(e).on("hashchange", G),
        b(a).keydown(function(f) {
            clearTimeout(X);
            var h = b(a.activeElement);
            if (!h.is("textarea") && !h.is("input") && !h.is("select") && O.keyboardScrolling) {
                var g = f.which;
                -1 < b.inArray(g, [40, 38, 32, 33, 34]) && f.preventDefault(),
        ...
        b(a).on("click", "#multiscroll-nav a", Z),
        b(a).on({
            mouseenter: I,
            mouseleave: al
        }, "#multiscroll-nav li"),
        O.normalScrollElements && (b(a).on("mouseenter", O.normalScrollElements, function() {
        ...
        function ah() {
            if (ab) {
                ...
                if (!f.is("textarea") && !f.is("input") && !f.is("select")) {
                    var g = b(e).height();
                    c.abs(g - R) > 20 * c.max(R, g) / 100 && (an(!0),
                    R = g)
                }
            } else {
                clearTimeout(j),
        ...
        function an(f) {
            ...
            O.scrollOverflow && scrollBarHandler.createScrollBarForAll(),
            q(),
            b.isFunction(O.afterResize) && O.afterResize.call(this)
        }
        function q() {
            O.css3 ? (aj(b(".ms-left"), "translate3d(0px, -" + b(".ms-left").find(".ms-section.active").position().top + "px, 0px)", !1),
            aj(b(".ms-right"), "translate3d(0px, -" + b(".ms-right").find(".ms-section.active").position().top + "px, 0px)", !1)) : (b(".ms-left").css("top", -b(".ms-left").find(".ms-section.active").position().top),
            b(".ms-right").css("top", -b(".ms-right").find(".ms-section.active").position().top))
        }
        function ao(k) {
            var C = k.index()
            ...
            ad = !0;
            var f, u, z, g = k.position().top, w = x.position().top;
            if (x.addClass("active").siblings().removeClass("active"),
            ...
            O.css3) {
                ...
                aj(b(".ms-right"), D, !0),
                setTimeout(function() {
                    b.isFunction(O.afterLoad) && O.afterLoad.call(this, y, C + 1),
                    setTimeout(function() {
                        ad = !1
                    }, U)
                }, O.scrollingSpeed)
            ...
            lastScrolledDestiny = y,
            f = y,
            O.menu && (b(O.menu).find(".active").removeClass("active"),
            b(O.menu).find('[data-menuanchor="' + f + '"]').addClass("active")),
            u = y,
            z = C,
            O.navigation && (b("#multiscroll-nav").find(".active").removeClass("active"),
            u ? b("#multiscroll-nav").find('a[href="#' + u + '"]').addClass("active") : b("#multiscroll-nav").find("li").eq(z).find("a").addClass("active"))
        }
        function am() {
            a.addEventListener ? (a.addEventListener("mousewheel", H, !1),
            a.addEventListener("wheel", H, !1)) : a.attachEvent("onmousewheel", H)
        }
        function H(f) {
            f = e.event || f;
            var g = c.max(-1, c.min(1, f.wheelDelta || -f.deltaY || -f.detail));
            return ad || (g < 0 ? ac.moveSectionDown() : ac.moveSectionUp()),
            !1
        }
        function aj(f, i, g) {
            var h;
            f.toggleClass("ms-easing", g),
            f.css({
        ...
        function N() {
            var f = b(".ms-left .ms-section.active")
              ...
              , h = f.index()
              , k = String(h);
            O.anchors.length && (k = l),
            k = k.replace("/", "-").replace("#", "");
            var g = new RegExp("\\b\\s?ms-viewing-[^\\s]+\\b","g");
            b("body")[0].className = b("body")[0].className.replace(g, ""),
            b("body").addClass("ms-viewing-" + k)
        }
        function Y(f) {
            var h = af;
        ...
        ac.moveSectionUp = function() {
            ...
            !f.length && O.loopTop && (f = b(".ms-left .ms-section").last()),
            f.length && ao(f)
        }
        ,
        ac.moveSectionDown = function() {
            var f = b(".ms-left .ms-section.active").next(".ms-section");
            !f.length && O.loopBottom && (f = b(".ms-left .ms-section").first()),
            f.length && ao(f)
        }
        ,
        ...
        ac.setMouseWheelScrolling = function(f) {
            f ? am() : a.addEventListener ? (a.removeEventListener("mousewheel", H, !1),
            a.removeEventListener("wheel", H, !1)) : a.detachEvent("onmousewheel", H)
        }
        ,
        ...
        function J(f) {
            if (aa(f)) {
                ...
                if (!ad) {
                    ...
                    A = g.y,
                    g.x,
                    c.abs(W - A) > b(e).height() / 100 * O.touchSensitivity && (A < W ? ac.moveSectionDown() : W < A && ac.moveSectionUp())
                }
            }
        }
        function aa(f) {
        ...
        function ap() {
            (V || ab) && (a.removeEventListener(ai.touchstart, ae),
            a.removeEventListener(ai.touchmove, J, {
                passive: !1
            }),
            a.addEventListener(ai.touchstart, ae),
            a.addEventListener(ai.touchmove, J, {
                passive: !1
            }))
        }
        function Q(f) {
            var g = [];
            return g.y = void 0 !== f.pageY && (f.pageY || f.pageX) ? f.pageY : f.touches[0].pageY,
            g.x = void 0 !== f.pageX && (f.pageY || f.pageX) ? f.pageX : f.touches[0].pageX,
            V && aa(f) && void 0 !== f.touches && (g.y = f.touches[0].pageY,
            g.x = f.touches[0].pageX),
            g
        }
        ac.destroy = function() {
            ac.setKeyboardScrolling(!1),
            ac.setMouseWheelScrolling(!1),
            (V || ab) && (a.removeEventListener(ai.touchstart, ae),
            a.removeEventListener(ai.touchmove, J, {
                passive: !1
            })),
            b(e).off("hashchange", G).off("resize", ah),
            b(a).off("mouseenter", "#multiscroll-nav li").off("mouseleave", "#multiscroll-nav li").off("click", "#multiscroll-nav a")
        }
        ,
        ac.build = function() {
            ac.setKeyboardScrolling(!0),
            ac.setMouseWheelScrolling(!0),
            ap(),
            b(e).on("hashchange", G).on("resize", ah),
            b(a).on("mouseenter", "#multiscroll-nav li", I).on("mouseleave", "#multiscroll-nav li", al).on("click", "#multiscroll-nav a", Z)
        }
    }
...
jQuery.effects || function(c, f) {
    ...
    function(D, v) {
        function e(l, n, m) {
            var h = g[n.type] || {};
            return null == l ? m || !n.def ? null : n.def : (l = h.floor ? ~~l : parseFloat(l),
            isNaN(l) ? n.def : h.mod ? (l + h.mod) % h.mod : 0 > l ? 0 : l > h.max ? h.max : l)
        }
        function C(i) {
            var h = E()
              , l = h._rgba = [];
            ...
            x(w, function(F, p) {
                var u, s = p.re.exec(i), a = s && p.parse(s), m = p.space || "rgba";
                return a ? (u = h[m](a),
                h[j[m].cache] = u[j[m].cache],
                l = h._rgba = u._rgba,
                !1) : v
            }),
            l.length ? ("0,0,0,0" === l.join() && D.extend(l, B.transparent),
            h) : B[i]
        }
        function y(a, l, h) {
            return h = (h + 1) % 1,
            1 > 6 * h ? a + 6 * (l - a) * h : 1 > 2 * h ? l : 2 > 3 * h ? a + 6 * (l - a) * (2 / 3 - h) : a
        }
        var B, z = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor".split(" "), q = /^([\-+])=\s*(\d+\.?\d*)/, w = [{
        ...
        E.fn = D.extend(E.prototype, {
            parse: function(s, t, m, r) {
                ...
                (s.jquery || s.nodeType) && (s = D(s).css(t),
                t = v);
                var a = this
                  , u = D.type(s)
                  , i = this._rgba = [];
                return t !== v && (s = [s, t, m, r],
                u = "array"),
                "string" === u ? this.parse(C(s) || B._default) : "array" === u ? (x(j.rgba.props, function(h, l) {
                    i[l.idx] = e(s[l.idx], l)
                }),
                this) : "object" === u ? (s instanceof E ? x(j, function(h, l) {
                    ...
                    a[l] && 0 > c.inArray(null, a[l].slice(0, 3)) && (a[l][3] = 1,
                    h.from && (a._rgba = h.from(a[l])))
                }),
                this) : v
            },
            is: function(i) {
                ...
                return x(j, function(a, p) {
                    var t, s = m[p.cache];
                    return s && (t = l[p.cache] || p.to && p.to(l._rgba) || [],
                    x(p.props, function(n, o) {
            ...
            transition: function(a, H) {
                var m = E(a)
                  ...
                  , l = u.slice();
                return m = m[p.cache],
                x(p.props, function(h, I) {
                    var o = I.idx
                      , t = u[o]
                      , i = m[o]
                      , J = g[I.type] || {};
                    null !== i && (null === t ? l[o] = i : (J.mod && (i - t > J.mod / 2 ? t += J.mod : t - i > J.mod / 2 && (t -= J.mod)),
                    l[o] = e((i - t) * H + t, I)))
                }),
                this[G](l)
            },
            ...
            toHslaString: function() {
                var a = "hsla("
                  , h = D.map(this.hsla(), function(i, l) {
                    return null == i && (i = l > 2 ? 1 : 0),
                    l && 3 > l && (i = Math.round(100 * i) + "%"),
                    i
                });
                return 1 === h[3] && (h.pop(),
                a = "hsl("),
        ...
        j.hsla.to = function(F) {
            if (null == F[0] || null == F[1] || null == F[2]) {
                return [null, null, null, F[3]]
            }
            var N, H, m = F[0] / 255, M = F[1] / 255, J = F[2] / 255, L = F[3], K = Math.max(m, M, J), G = Math.min(m, M, J), I = K - G, O = K + G, p = 0.5 * O;
            return N = G === K ? 0 : m === K ? 60 * (M - J) / I + 360 : M === K ? 60 * (J - m) / I + 120 : 60 * (m - M) / I + 240,
            H = 0 === p || 1 === p ? p : 0.5 >= p ? I / O : I / (2 - O),
            [Math.round(N) % 360, H, p, null == L ? 1 : L]
        }
        ,
        j.hsla.from = function(l) {
            ...
            var F = l[0] / 360
              ...
              , n = 2 * h - p;
            return [Math.round(255 * y(n, p, F + 1 / 3)), Math.round(255 * y(n, p, F)), Math.round(255 * y(n, p, F - 1 / 3)), u]
        }
        ,
        x(j, function(a, t) {
            var i = t.props
              ...
              , h = t.from;
            E.fn[a] = function(o) {
                if (m && !this[p] && (this[p] = m(this._rgba)),
                o === v) {
                    return this[p].slice()
                }
                var u, r = D.type(o), n = "array" === r || "object" === r ? o : arguments, l = this[p].slice();
            ...
            x(i, function(n, l) {
                E.fn[n] || (E.fn[n] = function(J) {
                    var G, I = D.type(J), H = "alpha" === n ? this._hsla ? "hsla" : "rgba" : a, F = this[H](), K = F[l.idx];
                    return "undefined" === I ? K : ("function" === I && (J = J.call(this, K),
                    I = D.type(J)),
                    null == J && l.empty ? this : ("string" === I && (G = q.exec(J),
                    G && (J = K + parseFloat(G[2]) * ("+" === G[1] ? 1 : -1))),
                    F[l.idx] = J,
                    this[H](F)))
                }
                )
        ...
        x(z, function(a, h) {
            D.cssHooks[h] = {
                set: function(m, i) {
                    ...
                    if ("string" !== D.type(i) || (t = C(i))) {
                        if (i = E(t || i),
                        !A.rgba && 1 !== i._rgba[3]) {
                            for (F = "backgroundColor" === h ? m.parentNode : m; ("" === u || "transparent" === u) && F && F.style; ) {
                                try {
                                    u = D.css(F, "backgroundColor"),
                                    F = F.parentNode
                                } catch (p) {}
                            }
            ...
            D.fx.step[h] = function(i) {
                i.colorInit || (i.start = E(i.elem, h),
                i.end = E(i.end),
                i.colorInit = !0),
    ...
    function() {
        function g() {
            var n, l, k = this.ownerDocument.defaultView ? this.ownerDocument.defaultView.getComputedStyle(this, null) : this.currentStyle, m = {};
            if (k && k.length && k[0] && k[k[0]]) {
                for (l = k.length; l--; ) {
                    n = k[l],
                    "string" == typeof k[n] && (m[c.camelCase(n)] = k[n])
                }
            } else {
                for (n in k) {
        ...
        function e(o, l) {
            ...
            for (k in l) {
                n = l[k],
                o[k] !== n && (h[k] || (c.fx.step[k] || !isNaN(parseFloat(n))) && (m[k] = n))
            }
            return m
        }
        ...
        c.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(k, a) {
            c.fx.step[a] = function(i) {
                ("none" !== i.end && !i.setAttr || 1 === i.pos && !i.setAttr) && (jQuery.style(i.elem, a, i.end),
                i.setAttr = !0)
            }
        }),
        c.effects.animateClass = function(m, i, l, k) {
            ...
            return this.queue(function() {
                var q, t = c(this), s = t.attr("class") || "", p = a.children ? t.find("*").andSelf() : t;
                p = p.map(function() {
                    var n = c(this);
                    return {
                        el: n,
                ...
                q(),
                p = p.map(function() {
                    return this.end = g.call(this.el[0]),
    ...
    function() {
        function e(k, h, g, j) {
            ...
            g = null,
            h = {}),
            ("number" == typeof h || c.fx.speeds[h]) && (j = g,
            g = h,
            h = {}),
            c.isFunction(g) && (j = g,
            g = null),
            ...
            k.complete = j || h.complete,
            k
        }
        function a(g) {
            return !g || "number" == typeof g || c.fx.speeds[g] ? !0 : "string" != typeof g || c.effects.effect[g] ? !1 : d && c.effects[g] ? !1 : !0
        }
        c.extend(c.effects, {
            version: "1.9.2",
            save: function(g, j) {
            ...
            restore: function(g, h) {
                ...
                for (j = 0; h.length > j; j++) {
                    null !== h[j] && (k = g.data(b + h[j]),
                    k === f && (k = ""),
                    g.css(h[j], k))
                }
            },
            setMode: function(g, h) {
                return "toggle" === h && (h = g.is(":hidden") ? "show" : "hide"),
                h
            },
            ...
            createWrapper: function(m) {
                ...
                return m.wrap(g),
                (m[0] === j || c.contains(m[0], j)) && c(j).focus(),
                g = m.parent(),
                "static" === m.css("position") ? (g.css({
                    position: "relative"
                }),
                m.css({
                    position: "relative"
                ...
                c.each(["top", "left", "bottom", "right"], function(n, i) {
                    h[i] = m.css(i),
                    isNaN(parseInt(h[i], 10)) && (h[i] = "auto")
                }),
                m.css({
                    position: "relative",
                    top: 0,
            ...
            removeWrapper: function(h) {
                ...
                return h.parent().is(".ui-effects-wrapper") && (h.parent().replaceWith(h),
                (h[0] === g || c.contains(h[0], g)) && c(g).focus()),
                h
            },
        ...
        c.fn.extend({
            effect: function() {
                ...
                return c.fx.off || !k && !i ? j ? this[j](g.duration, g.complete) : this.each(function() {
    ...
    function() {
        ...
        c.extend(a, {
            ...
            Elastic: function(g) {
                return 0 === g || 1 === g ? g : -Math.pow(2, 8 * (g - 1)) * Math.sin((80 * (g - 1) - 7.5) * Math.PI / 15)
            },
            Back: function(g) {
                return g * g * (3 * g - 2)
            },
            Bounce: function(g) {
                for (var j, h = 4; ((j = Math.pow(2, --h)) - 1) / 11 > g; ) {}
                return 1 / Math.pow(4, 3 - h) - 7.5625 * Math.pow((3 * j - 2) / 22 - g, 2)
            }
        }),
        c.each(a, function(g, e) {
            c.easing["easeIn" + g] = e,
            c.easing["easeOut" + g] = function(h) {
                return 1 - e(1 - h)
            }
            ,
